"""
Django settings for General Balance project.
...
SECRET_KEY = env("SECRET_KEY", default="TCAomzdKyGnfbhCFYrZsBXITkIbUYMdmSyWszZfK")
...
WSGI_APPLICATION = "general_balance.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="general_balance"),
...
EMAIL_SUBJECT_PREFIX = "[General Balance] "
...
ADMINS = [("Kyle", "kylehunt22@gmail.com")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "general_balance": {
            "handlers": ["console"],
            "level": env("GENERAL_BALANCE_LOG_LEVEL", default="INFO"),
        },
    },
}
