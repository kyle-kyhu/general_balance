        ...
        if arg_count == 1:
            ...
            if isinstance(arg_1, datetime):
                ...
                if isinstance(arg_2, (dt_tzinfo, str)):
                    ...
                    raise TypeError(f"Cannot parse two arguments of types 'datetime', {type(arg_2)!r}.")
                ...
                if isinstance(arg_2, (dt_tzinfo, str)):
                    ...
                    raise TypeError(f"Cannot parse two arguments of types 'date', {type(arg_2)!r}.")

            # (str, format) -> parse @ tzinfo
            elif isinstance(arg_1, str) and isinstance(arg_2, (str, list)):
                dt = parser.DateTimeParser(locale).parse(args[0], args[1], normalize_whitespace)
                return self.type.fromdatetime(dt, tzinfo=tz)

            else:
                raise TypeError(f"Cannot parse two arguments of types {type(arg_1)!r} and {type(arg_2)!r}.")
