...
class Arrow:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._datetime = dt_datetime(year, month, day, hour, minute, second, microsecond, tzinfo, fold=fold)
    ...
    @classmethod
    def strptime(cls, date_str: str, fmt: str, tzinfo: Optional[TZ_EXPR] = None) -> "Arrow":
    ...
    def shift(self, **kwargs: Any) -> "Arrow":
        ...
        for key, value in kwargs.items():
            if key in self._ATTRS_PLURAL or key in additional_attrs:
                ...
                raise ValueError(f"Invalid shift time frame. Please select one of the following: {supported_attr}.")
    ...
    def is_between(
        ...
        if not isinstance(start, Arrow):
            raise TypeError(f"Cannot parse start date argument type of {type(start)!r}.")
