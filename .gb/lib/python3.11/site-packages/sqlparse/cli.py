...
def create_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="sqlformat",
        description='Format FILE according to OPTIONS. Use "-" as FILE ' "to read from stdin.",
    ...
    parser.add_argument(
        "-o", "--outfile", dest="outfile", metavar="FILE", help="write output to FILE (defaults to stdout)"
    )
    ...
    group.add_argument(
        ...
        dest="output_format",
        choices=["python", "php"],
        help="output a snippet in programming language LANG, " 'choices are "python", "php"',
    )

    group.add_argument(
        "--strip-comments", dest="strip_comments", action="store_true", default=False, help="remove comments"
    )

    group.add_argument(
        "-r", "--reindent", dest="reindent", action="store_true", default=False, help="reindent statements"
    )

    group.add_argument(
        "--indent_width", dest="indent_width", default=2, type=int, help="indentation width (defaults to 2 spaces)"
    )
    ...
    group.add_argument(
        "-a", "--reindent_aligned", action="store_true", default=False, help="reindent statements to aligned format"
    )
    ...
    group.add_argument(
        "--wrap_after", dest="wrap_after", default=0, type=int, help="Column after which lists should be wrapped"
    )
    ...
    group.add_argument(
        "--compact", dest="compact", default=False, type=bool, help="Try to produce more compact output (default False)"
    )

    group.add_argument(
        "--encoding", dest="encoding", default="utf-8", help="Specify the input encoding (default utf-8)"
    )
