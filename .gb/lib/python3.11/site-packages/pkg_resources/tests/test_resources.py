...
class TestEntryPoints:
    ...
    def setup_method(self, method):
        self.dist = Distribution.from_filename("FooPkg-1.2-py2.4.egg", metadata=Metadata(("requires.txt", "[x]")))
    ...
    def testDeprecationWarnings(self):
        ep = EntryPoint("foo", "pkg_resources.tests.test_resources", ["TestEntryPoints"], ["x"])
...
class TestRequirements:
    ...
    def testOrdering(self):
        ...
        assert Requirement("Twisted") != Requirement("Twisted @ https://localhost/twisted.zip")
    ...
    def testOptionsAndHashing(self):
        ...
        assert hash(Requirement.parse("Twisted @ https://localhost/twisted.zip")) == hash(
            (
                "twisted",
...
class TestParsing:
    ...
    def test_requirements_with_markers(self):
        assert Requirement.parse("foobar;os_name=='a'") == Requirement.parse("foobar;os_name=='a'")
        assert Requirement.parse("name==1.1;python_version=='2.7'") != Requirement.parse(
            "name==1.1;python_version=='3.6'"
        )
        assert Requirement.parse("name==1.0;python_version=='2.7'") != Requirement.parse(
            "name==1.2;python_version=='2.7'"
        )
        assert Requirement.parse("name[foo]==1.0;python_version=='3.6'") != Requirement.parse(
            "name[foo,bar]==1.0;python_version=='3.6'"
        )
