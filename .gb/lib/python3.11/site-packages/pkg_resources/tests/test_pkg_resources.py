...
def test_get_metadata__bad_utf8(tmpdir):
    ...
    expected = (
        ...
        "codec can't decode byte 0xe9 in position 1: " "invalid continuation byte in METADATA file at path: "
    )
...
def test_distribution_version_missing(tmpdir, suffix, expected_filename, expected_dist_type):
    """
    ...
    expected_text = ("Missing 'Version:' header and/or {} file at path: ").format(expected_filename)
