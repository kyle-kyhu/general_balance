...
def ireq_satisfied_by_existing_pin(ireq: InstallRequirement, existing_pin: InstallationCandidate) -> bool:
    """
    ...
    result = ireq.req.specifier.contains(version, prereleases=existing_pin.req.specifier.prereleases)
...
class LocalRequirementsRepository(BaseRepository):
    ...
    def find_best_match(self, ireq: InstallRequirement, prereleases: bool | None = None) -> InstallationCandidate:
