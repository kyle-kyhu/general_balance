...
class DependencyCache:
    ...
    def reverse_dependencies(self, ireqs: Iterable[InstallRequirement]) -> dict[str, set[str]]:
        """
    ...
    def _reverse_dependencies(self, cache_keys: Iterable[tuple[str, str]]) -> dict[str, set[str]]:
        """
