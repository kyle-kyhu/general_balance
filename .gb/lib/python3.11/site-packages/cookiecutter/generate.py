        ...
        if isinstance(context_value, list):
            ...
            if isinstance(overwrite, list):
                ...
                if overwrite in context_value:
                    ...
                    raise ValueError(
                        f"{overwrite} provided for choice variable " f"{variable}, but the choices are {context_value}."
                    )
...
def generate_context(context_file="cookiecutter.json", default_context=None, extra_context=None):
    ...
    try:
        ...
        our_exc_message = (
            f"JSON decoding error while loading '{full_fpath}'. " f"Decoding error details: '{json_exc_message}'"
        )
