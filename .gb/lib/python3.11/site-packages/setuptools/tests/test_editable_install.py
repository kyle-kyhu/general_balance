...
class TestLegacyNamespaces:
    ...
    def test_namespace_package_importable(self, venv, tmp_path, ns, impl, editable_opts):
        """
...
class TestOverallBehaviour:
    ...
    def test_editable_install(self, tmp_path, venv, layout, editable_opts):
        project, _ = install_project("mypkg", venv, tmp_path, self.EXAMPLES[layout], *editable_opts)
...
def _addsitedirs(new_dirs):
    ...
    """
    content = "\n".join(("import site",) + tuple(f"site.addsitedir({os.fspath(new_dir)!r})" for new_dir in new_dirs))
