...
class TestSdistTest:
    ...
    _INVALID_PATHS = {
        ...
        "can't have `..` segments": lambda: (os.path.join("sdist_test", "..", "sdist_test", "f.h")),
        "doesn't exist": lambda: (os.path.join("sdist_test", "this_file_does_not_exist.h")),
    ...
    def test_add_files_referenced_by_config_directives(self, source_dir, config):
        ...
        assert "src/VERSION.txt" in cmd.filelist.files or "src\\VERSION.txt" in cmd.filelist.files
...
class TestRegressions:
    ...
    @pytest.mark.parametrize("dep_path", ("myheaders/dir/file.h", "myheaders/dir/../dir/file.h"))
    ...
    @pytest.mark.parametrize("dep_path", ("$tmp_path$/external/dir/file.h", "../external/dir/file.h"))
