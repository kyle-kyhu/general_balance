...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "setup.py",
            SETUPPY_EXAMPLE.replace(")", "  license_files=['licenses/DUMMYFILE', 'LICENSE'])"),
        ),
    ],
)
...
@pytest.mark.filterwarnings("once:Config variable '.*' is unset.*, Python ABI tag may be incorrect")
...
@pytest.mark.skipif(platform.system() != "Linux", reason="Only makes sense to test on Linux")
