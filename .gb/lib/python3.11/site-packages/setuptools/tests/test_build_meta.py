...
pytestmark = pytest.mark.skipif(
    ...
    reason="The combination of PyPy + Windows + pytest-xdist + ProcessPoolExecutor " "is flaky and problematic",
)
...
class TestBuildMetaBackend:
    ...
    def test_build_with_pyproject_config(self, tmpdir, setup_script):
        ...
        for line in (
            ...
            "Requires-Dist: " + str(Requirement('importlib; python_version=="2.6" and extra =="all"')),
        ):
