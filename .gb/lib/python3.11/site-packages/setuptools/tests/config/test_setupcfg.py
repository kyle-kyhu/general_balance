...
class TestMetadata:
    ...
    def test_file_mixed(self, tmpdir):
        ...
        with get_dist(tmpdir) as dist:
            assert dist.metadata.long_description == ("readme contents\nline2\nchangelog contents\nand stuff")
    ...
    def test_version(self, tmpdir):
        package_dir, config = fake_env(tmpdir, "[metadata]\nversion = attr: fake_package.VERSION\n")
        ...
        sub_b.join("mod.py").write("import third_party_module\nVERSION = (2016, 11, 26)")
