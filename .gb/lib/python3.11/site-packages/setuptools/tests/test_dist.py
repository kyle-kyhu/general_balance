...
def test_provides_extras_deterministic_order():
    ...
    attrs["extras_require"] = collections.OrderedDict(reversed(list(attrs["extras_require"].items())))
    dist = Distribution(attrs)
...
CHECK_PACKAGE_DATA_TESTS = (
    ...
    (
        ...
        ("'package_data' must be a dictionary mapping package" " names to lists of string wildcard patterns"),
    ),
    # Invalid key type.
    (
        {
    ...
    (
        ...
        ("\"values of 'package_data' dict\" must be a list of strings " "(got <generator object"),
    ),
)
...
def test_dist_default_packages(tmp_path, dist_name, package_dir, package_files, packages):
