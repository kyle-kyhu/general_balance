...
class TestPackageIndex:
    ...
    def test_egg_fragment(self):
        ...
        for v, vc in versions:
            dists = list(
                setuptools.package_index.distros_for_url("http://example.com/example-foo.zip#egg=example-foo-" + v)
            )
...
class TestContentCheckers:
    def test_md5(self):
        checker = setuptools.package_index.HashChecker.from_url("http://foo/bar#md5=f12895fdffbd45007040d2e44df98478")
