...
def read_configuration(filepath: StrPath, find_others=False, ignore_option_errors=False) -> dict:
...
class ConfigHandler(Generic[Target]):
    ...
    @classmethod
    def _section_options(cls, options: AllCommandOptions) -> Iterator[tuple[str, SingleCommandOptions]]:
    ...
    def parse(self) -> None:
        ...
        for section_name, section_options in self.sections.items():
            ...
            if section_parser_method is None:
                raise OptionError("Unsupported distribution option section: " f"[{self.section_prefix}.{section_name}]")
    ...
    def _parse_version(self, value):
        ...
        if version != value:
            ...
            try:
                ...
                raise OptionError(f"Version loaded from {value} does not " f"comply with PEP 440: {version}") from e
