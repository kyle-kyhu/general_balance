...
def _file_with_extension(directory: StrPath, extension: str | tuple[str, ...]):
    ...
    try:
        ...
        raise ValueError(
            "No distribution was found. Ensure that `setup.py` " "is not empty and that it calls `setup()`."
        ) from None
    return file
...
class _BuildMetaBackend(_ConfigSettingsTranslator):
    ...
    def build_sdist(self, sdist_directory: StrPath, config_settings: _ConfigSettings = None):
