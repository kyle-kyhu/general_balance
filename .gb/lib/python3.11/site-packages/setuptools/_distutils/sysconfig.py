...
def get_python_inc(plat_specific=False, prefix=None):
    ...
    try:
        ...
        raise DistutilsPlatformError(
            "I don't know where Python installs its C header files " f"on platform '{os.name}'"
        )
...
def customize_compiler(compiler):
    ...
    """
    if compiler.compiler_type in ["unix", "cygwin"] or (compiler.compiler_type == "mingw32" and is_mingw()):
        _customize_macos()
