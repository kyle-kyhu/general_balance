...
class build_ext(Command):
    ...
    user_options = [
        ...
        (
            "plat-name=",
            "p",
            "platform name to cross-compile for, if supported " f"[default: {get_platform()}]",
        ),
        (
            "inplace",
            "i",
    ...
    def find_swig(self):
        ...
        if os.name == "posix":
            ...
            raise DistutilsPlatformError("I don't know how to find (much less run) SWIG " f"on platform '{os.name}'")
