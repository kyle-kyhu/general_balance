...
class install(Command):
    ...
    def finalize_unix(self):
        ...
        if self.install_base is not None or self.install_platbase is not None:
            incomplete_scheme = (
                (self.install_lib is None and self.install_purelib is None and self.install_platlib is None)
    ...
    def finalize_other(self):
        ...
        if self.user:
            ...
            try:
                ...
                raise DistutilsPlatformError(f"I don't know how to install stuff on '{os.name}'")
    ...
    def handle_extra_path(self):
        ...
        if self.extra_path is not None:
            log.warning("Distribution option extra_path is deprecated. " "See issue27919 for details.")
