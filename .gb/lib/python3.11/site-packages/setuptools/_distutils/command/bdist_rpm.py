...
class bdist_rpm(Command):
    ...
    def finalize_options(self):
        ...
        if os.name != "posix":
            raise DistutilsPlatformError(f"don't know how to create RPM distributions on platform {os.name}")
    ...
    def run(self):  # noqa: C901
        ...
        self.execute(write_file, (spec_path, self._make_spec_file()), f"writing '{spec_path}'")
    ...
    def _make_spec_file(self):  # noqa: C901
        ...
        vendor_hook = "\n".join([f"  {line.strip()} \\" for line in vendor_hook.splitlines()])
