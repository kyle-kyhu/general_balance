...
class Extension:
    ...
    def __init__(
        ...
        **kw,  # To catch unknown keywords
        ...
        if not (isinstance(sources, list) and all(isinstance(v, (str, os.PathLike)) for v in sources)):
            raise AssertionError("'sources' must be a list of strings or PathLike objects.")
