...
class SystemInfo:
    ...
    def VSInstallDir(self):
        ...
        """
        # Default path
        default = os.path.join(self.ProgramFilesx86, "Microsoft Visual Studio %0.1f" % self.vs_ver)
    ...
    def _guess_vc_legacy(self):
        ...
        str
            path
        """
        default = os.path.join(self.ProgramFilesx86, r"Microsoft Visual Studio %0.1f\VC" % self.vs_ver)
    ...
    def NetFxSdkVersion(self):
        ...
        return (
            ("4.7.2", "4.7.1", "4.7", "4.6.2", "4.6.1", "4.6", "4.5.2", "4.5.1", "4.5") if self.vs_ver >= 14.0 else ()
        )
    ...
    def _use_last_dir_name(path, prefix=""):
        ...
        matching_dirs = (
            ...
            if os.path.isdir(os.path.join(path, dir_name)) and dir_name.startswith(prefix)
        )
...
class EnvironmentInfo:
    ...
    def VCTools(self):
        ...
        if self.vs_ver == 14.0:
            ...
            tools += [os.path.join(si.VCInstallDir, host_dir % self.pi.target_dir(x64=True))]

            if self.pi.current_cpu != self.pi.target_cpu:
                tools += [os.path.join(si.VCInstallDir, host_dir % self.pi.current_dir(x64=True))]
