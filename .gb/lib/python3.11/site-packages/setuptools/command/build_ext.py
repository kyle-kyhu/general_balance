...
class build_ext(_build_ext):
    ...
    def _get_internal_depends(self) -> Iterator[str]:
        ...
        def skip(orig_path: str, reason: str) -> None:
            log.info(
                "dependency %s won't be automatically " "included in the manifest: the path %s",
                orig_path,
                reason,
            )
    ...
    def __get_stubs_outputs(self):
        ...
        ns_ext_bases = (
            os.path.join(self.build_lib, *ext._full_name.split(".")) for ext in self.extensions if ext._needs_stub
        )
