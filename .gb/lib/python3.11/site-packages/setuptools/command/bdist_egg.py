...
class bdist_egg(Command):
    ...
    user_options = [
        ...
        (
            "plat-name=",
            "p",
            "platform name to embed in generated filenames " "(by default uses `pkg_resources.get_build_platform()`)",
        ),
...
def make_zipfile(zip_filename, base_dir, verbose=False, dry_run=False, compress=True, mode="w"):
