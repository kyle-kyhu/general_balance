...
class upload_docs(upload):
    ...
    def has_sphinx(self):
        return bool(self.upload_dir is None and metadata.entry_points(group="distutils.commands", name="build_sphinx"))
    ...
    def upload_file(self, filename):
        ...
        schema, netloc, url, params, query, fragments = urllib.parse.urlparse(self.repository)
