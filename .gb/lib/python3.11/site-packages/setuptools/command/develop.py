...
class develop(namespaces.DevelopInstaller, easy_install):
    ...
    def finalize_options(self):
        ...
        egg_link_fn = _normalization.filename_component_broken(ei.egg_name) + ".egg-link"
    ...
    def uninstall_link(self):
        if os.path.exists(self.egg_link):
            ...
            contents = [line.rstrip() for line in _read_utf8_with_fallback(self.egg_link).splitlines()]
