...
def _fetch_build_egg_no_warn(dist, req):  # noqa: C901  # is too complex (16)  # FIXME
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        dist_metadata = pkg_resources.PathMetadata(dist_location, os.path.join(dist_location, "EGG-INFO"))
        return pkg_resources.Distribution.from_filename(dist_location, metadata=dist_metadata)
