...
class Layout:
    ...
    def tree(self) -> "Tree":
        ...
        def summary(layout: "Layout") -> Table:
            ...
            text: RenderableType = Pretty(layout) if layout.visible else Styled(Pretty(layout), "dim")
    ...
    def split(
        ...
        *layouts: Union["Layout", RenderableType],
        ...
        try:
            self.splitter = splitter if isinstance(splitter, Splitter) else self.splitters[splitter]()
        except KeyError:
    ...
    def render(self, console: Console, options: ConsoleOptions) -> RenderMap:
        ...
        layout_regions = [(layout, region) for layout, region in region_map.items() if not layout.children]
