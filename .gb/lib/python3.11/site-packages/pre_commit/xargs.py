...
def _thread_mapper(maxsize: int) -> Generator[Callable[[Callable[[TArg], TRet], Iterable[TArg]], Iterable[TRet]],]:
    if maxsize == 1:
        yield map
    else:
...
def xargs(
    ...
    **kwargs: Any,
    ...
    if sys.platform == "win32" and cmd[0].lower().endswith((".bat", ".cmd")):  # pragma: win32 cover
