...
class Store:
    ...
    def __init__(self, directory: str | None = None) -> None:
        ...
        self.readonly = os.path.exists(self.directory) and not os.access(self.directory, os.W_OK)
    ...
    def _create_config_table(self, db: sqlite3.Connection) -> None:
        db.executescript(
            "CREATE TABLE IF NOT EXISTS configs (" "   path TEXT NOT NULL," "   PRIMARY KEY (path)" ");",
        )
