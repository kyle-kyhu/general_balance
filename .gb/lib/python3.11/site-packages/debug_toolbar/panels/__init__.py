...
class Panel:
    ...
    def enabled(self) -> bool:
        ...
        return panel_path not in disabled_panels and panel_path.replace(".panel.", ".") not in disabled_panels
    ...
    def get_headers(self, request):
        ...
        if stats:
            headers["Server-Timing"] = ", ".join(
                ...
                '{}_{};dur={};desc="{}"'.format(self.panel_id, key, record.get("value"), record.get("title"))
