...
class HtmlFormatter(Formatter):
    ...
    **Subclassing the HTML formatter**
    ...
    def get_token_style_defs(self, arg=None):
        ...
        styles = [
            (level, ttype, cls, style) for cls, (style, ttype, level) in self.class2style.items() if cls and style
        ]
        styles.sort()

        lines = [f"{prefix(cls)} {{ {style} }} /* {repr(ttype)[6:]} */" for (level, ttype, cls, style) in styles]
    ...
    def get_background_style_defs(self, arg=None):
        ...
        if arg and not self.nobackground and bg_color is not None:
            ...
            lines.insert(0, "{}{{ background: {};{} }}".format(prefix(""), bg_color, text_style))
        if hl_color is not None:
            lines.insert(0, "{} {{ background-color: {} }}".format(prefix("hll"), hl_color))
    ...
    def _wrap_full(self, inner, outfile):
        if self.cssfile:
            ...
            yield (
                0,
                (DOC_HEADER % dict(title=self.title, styledefs=self.get_style_defs("body"), encoding=self.encoding)),
            )
    ...
    def _wrap_div(self, inner):
        ...
        yield 0, ("<div" + (self.cssclass and f' class="{self.cssclass}"') + (style and (f' style="{style}"')) + ">")
        yield from inner
        yield 0, "</div>\n"
        ...
        for ttype, value in tokensource:
            ...
            if tagsfile and ttype in Token.Name:
                ...
                if linenumber:
                    ...
                    url = self.tagurlformat % {"path": base, "fname": filename, "fext": extension}
            ...
            for part in parts[:-1]:
                if line:
                    ...
                    if lspan != cspan and part:
                        line.extend(((lspan and "</span>"), cspan, part, (cspan and "</span>"), lsep))
