...
class QVToLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            (r"\n", Text),
            (r"[^\S\n]+", Text),
            (r"(--|//)(\s*)(directive:)?(.*)$", bygroups(Comment, Comment, Comment.Preproc, Comment)),
            ...
            (
                r"(metamodel|class|exception|primitive|enum|transformation|" r"library)(\s+)(\w+)",
            ...
            (r"(Bag|Collection|Dict|OrderedSet|Sequence|Set|Tuple|List)\b", Keyword.Type),
            include("keywords"),
        ...
        "operation": [
            (r"::", Text),
            (r"(.*::)([a-zA-Z_]\w*)([ \t]*)(\()", bygroups(Text, Name.Function, Text, Punctuation), "#pop"),
        ],
        "assert": [
        ...
        "stringescape": [(r'\\([\\btnfr"\']|u[0-3][0-7]{2}|u[0-7]{1,2})', String.Escape)],
