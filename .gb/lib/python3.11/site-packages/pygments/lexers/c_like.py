...
class ECLexer(CLexer):
    ...
    tokens = {
        "statements": [
            ...
            (
                words(("uint", "uint16", "uint32", "uint64", "bool", "byte", "unichar", "int64"), suffix=r"\b"),
                Keyword.Type,
            ),
            (r"(class)(\s+)", bygroups(Keyword, Whitespace), "classname"),
...
class ValaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "statements": [
            ...
            (r"[~!%^&*+=|?:<>/-]", Operator),
            (r"(\[)(Compact|Immutable|(?:Boolean|Simple)Type)(\])", bygroups(Punctuation, Name.Decorator, Punctuation)),
            # TODO: "correctly" parse complex code attributes
            (r"(\[)(CCode|(?:Integer|Floating)Type)", bygroups(Punctuation, Name.Decorator)),
            (r"[()\[\],.]", Punctuation),
            (
                words(
                    (
            ...
            (r"(namespace|using)(\s+)", bygroups(Keyword.Namespace, Whitespace), "namespace"),
            (r"(class|errordomain|interface|struct)(\s+)", bygroups(Keyword.Declaration, Whitespace), "class"),
...
class CharmciLexer(CppLexer):
    ...
    tokens = {
        "keywords": [
            ...
            (
                words(("mainmodule", "mainchare", "chare", "array", "group", "nodegroup", "message", "conditional")),
                Keyword,
            ),
            (
                words(
...
class OmgIdlLexer(CLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"(?i)(enum|bitmask)(\s+)(\w+)", bygroups(Keyword, Whitespace, Name.Class), "enum"),
            (r"(?i)(module)(\s+)(\w+)", bygroups(Keyword.Namespace, Whitespace, Name.Namespace)),
...
class PromelaLexer(CLexer):
    ...
    tokens = {
        ...
        "types": [
            ...
            (words(("bit", "bool", "byte", "pid", "short", "int", "unsigned"), suffix=r"\b"), Keyword.Type),
        ],
        "keywords": [
            # ControlFlow
            (
                words(
                    ("atomic", "break", "d_step", "do", "od", "for", "in", "goto", "if", "fi", "unless"), suffix=r"\b"
                ),
                Keyword,
            ),
            # BasicStatements
            (words(("assert", "get_priority", "printf", "printm", "set_priority"), suffix=r"\b"), Name.Function),
            # Embedded C Code
            (words(("c_code", "c_decl", "c_expr", "c_state", "c_track"), suffix=r"\b"), Keyword),
            # Predefined (local/global variables)
            (words(("_", "_last", "_nr_pr", "_pid", "_priority", "else", "np_", "STDIN"), suffix=r"\b"), Name.Builtin),
            # Predefined (functions)
            (
                words(("empty", "enabled", "eval", "full", "len", "nempty", "nfull", "pc_value"), suffix=r"\b"),
                Name.Function,
            ),
