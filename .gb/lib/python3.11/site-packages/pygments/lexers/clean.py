...
class CleanLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "import.what": [
            (r"\b(class)\b(\s+)(" + classId + r")", bygroups(Keyword, Whitespace, Name.Class), "import.what.class"),
            (
                r"\b(instance)(\s+)(" + classId + r")(\s+)",
                bygroups(Keyword, Whitespace, Name.Class, Whitespace),
                "import.what.instance",
            ),
            (r"(::)(\s*)\b(" + upperId + r")\b", bygroups(Punctuation, Whitespace, Name.Class), "import.what.type"),
            (r"\b(generic)\b(\s+)\b(" + lowerId + "|" + upperId + r")\b", bygroups(Keyword, Whitespace, Name)),
            include("names"),
