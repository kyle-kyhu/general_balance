...
class CsoundLexer(RegexLexer):
    ...
    tokens = {
        ...
        "include directive": [include("whitespace"), (r"([^ \t]).*?\1", String, "#pop")],
        "includestr directive": [include("whitespace"), (r'"', String, ("#pop", "quoted string"))],
        "define directive": [
            (r"\n", Whitespace),
            include("whitespace"),
            (r"([A-Z_a-z]\w*)(\()", bygroups(Comment.Preproc, Punctuation), ("#pop", "macro parameter name list")),
        ...
        "before macro body": [(r"\n", Whitespace), include("whitespace"), (r"#", Punctuation, ("#pop", "macro body"))],
        "macro body": [
            (r"(?:\\(?!#)|[^#\\]|\n)+", Comment.Preproc),
            (r"\\#", Comment.Preproc),
            (r"(?<!\\)#", Punctuation, "#pop"),
        ],
        "macro directive": [include("whitespace"), (r"[A-Z_a-z]\w*", Comment.Preproc, "#pop")],
        "macro uses": [
            (r"(\$[A-Z_a-z]\w*\.?)(\()", bygroups(Comment.Preproc, Punctuation), "macro parameter value list"),
        ...
        "quoted string": [(r'"', String, "#pop"), (r'[^"$]+', String), include("macro uses"), (r"[$]", String)],
        "braced string": [
...
class CsoundOrchestraLexer(CsoundLexer):
    ...
    tokens = {
        ...
        "partial statements": [
            ...
            (r"\b(r(?:einit|igoto)|tigoto)(\(|\b)", bygroups(Keyword.Pseudo, Punctuation), "goto label"),
            (
        ...
        "format specifiers": [(r"%[#0\- +]*\d*(?:\.\d+)?[AE-GXac-giosux]", String.Interpol), (r"%%", String.Escape)],
        "goto argument": [
            include("whitespace and macro uses"),
            (r",", Punctuation, "#pop"),
            include("partial statements"),
        ],
        "goto label": [include("whitespace and macro uses"), (r"\w+", Name.Label, "#pop"), default("#pop")],
        "prints opcode": [
            include("whitespace and macro uses"),
        ...
        "Csound score": [(r"\}\}", String, "#pop"), (r"([^}]+)|\}(?!\})", using(CsoundScoreLexer))],
        "Python opcode": [
            include("whitespace and macro uses"),
            (r'"', String, "quoted string"),
            (r"\{\{", String, "Python"),
        ...
        "Python": [(r"\}\}", String, "#pop"), (r"([^}]+)|\}(?!\})", using(PythonLexer))],
        "Lua opcode": [
            include("whitespace and macro uses"),
            (r'"', String, "quoted string"),
            (r"\{\{", String, "Lua"),
...
class CsoundDocumentLexer(RegexLexer):
    ...
    tokens = {
        ...
        "tag": [(r"\s+", Whitespace), (r"[\w.:-]+\s*=", Name.Attribute, "attr"), (r"/?\s*>", Name.Tag, "#pop")],
        "attr": [
            (r"\s+", Whitespace),
            (r'".*?"', String, "#pop"),
            (r"'.*?'", String, "#pop"),
