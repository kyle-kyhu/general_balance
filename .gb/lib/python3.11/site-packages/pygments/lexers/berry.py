...
class BerryLexer(RegexLexer):
    ...
    tokens = {
        ...
        "whitespace": [(r"\s+", Whitespace), (r"#-(.|\n)*?-#", Comment.Multiline), (r"#.*?$", Comment.Single)],
        "keywords": [
            (words(("as", "break", "continue", "import", "static", "self", "super"), suffix=r"\b"), Keyword.Reserved),
        ...
        "strings": [(r'"([^\\]|\\.)*?"', String.Double, "#pop"), (r"\'([^\\]|\\.)*?\'", String.Single, "#pop")],
    }
