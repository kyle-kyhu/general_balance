...
class SmartGameFormatLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # date:
            (r"(\[)([0-9]{4}-[0-9]{2}-[0-9]{2})(\])", bygroups(Punctuation, Literal.Date, Punctuation)),
            # point:
            (r"(\[)([a-z]{2})(\])", bygroups(Punctuation, String, Punctuation)),
            # double points:
            (r"(\[)([a-z]{2})(:)([a-z]{2})(\])", bygroups(Punctuation, String, Punctuation, String, Punctuation)),
            (r"(\[)([\w\s#()+,\-.:?]+)(\])", bygroups(Punctuation, String, Punctuation)),
