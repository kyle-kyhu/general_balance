...
class RubyLexer(ExtendedRegexLexer):
    ...
    def gen_rubystrings_rules():
        ...
        states["strings"] = [
            ...
            (r"([a-zA-Z_]\w*)(:)(?!:)", bygroups(String.Symbol, Punctuation)),  # Since Ruby 1.9
        ...
        for lbrace, rbrace, bracecc, name in (
            ...
            states["strings"].append((r"%[QWx]?" + lbrace, String.Other, name + "-intp-string"))
            states[name + "-string"] = [
                (r"\\[\\" + bracecc + "]", String.Other),
                (lbrace, String.Other, "#push"),
                (rbrace, String.Other, "#pop"),
            ...
            states["strings"].append((r"%[qsw]" + lbrace, String.Other, name + "-string"))
            states[name + "-regex"] = [
        ...
        states["strings"] += [
            ...
            (r"(?<=[-+/*%=<>&!^|~,(])(\s*)(%([\t ])(?:(?:\\\3|(?!\3).)*)\3)", bygroups(Whitespace, String.Other, None)),
    ...
    tokens = {
        "root": [
            ...
            (r"(module)(\s+)([a-zA-Z_]\w*" r"(?:::[a-zA-Z_]\w*)*)", bygroups(Keyword, Whitespace, Name.Namespace)),
            ...
            (r"(\s+)(/)(?![\s=])", bygroups(Whitespace, String.Regex), "multiline-regex"),
            ...
            # stupid example:
            #   x>=0?n[x]:""
            (r"(0_?[0-7]+(?:_[0-7]+)*)(\s*)([/?])?", bygroups(Number.Oct, Whitespace, Operator)),
            (r"(0x[0-9A-Fa-f]+(?:_[0-9A-Fa-f]+)*)(\s*)([/?])?", bygroups(Number.Hex, Whitespace, Operator)),
            (r"(0b[01]+(?:_[01]+)*)(\s*)([/?])?", bygroups(Number.Bin, Whitespace, Operator)),
            (r"([\d]+(?:_\d+)*)(\s*)([/?])?", bygroups(Number.Integer, Whitespace, Operator)),
            # Names
            ...
            (words(RUBY_OPERATORS, prefix=r"(\.|::)"), bygroups(Operator, Name.Operator)),
...
class FancyLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r'"(\\\\|\\[^\\]|[^"\\])*"', String),
            # keywords
            (r"(def|class|try|catch|finally|retry|return|return_local|match|" r"case|->|=>)\b", Keyword),
            # constants
            ...
            (r"(0[oO]?[0-7]+(?:_[0-7]+)*)(\s*)([/?])?", bygroups(Number.Oct, Whitespace, Operator)),
            (r"(0[xX][0-9A-Fa-f]+(?:_[0-9A-Fa-f]+)*)(\s*)([/?])?", bygroups(Number.Hex, Whitespace, Operator)),
            (r"(0[bB][01]+(?:_[01]+)*)(\s*)([/?])?", bygroups(Number.Bin, Whitespace, Operator)),
            (r"([\d]+(?:_\d+)*)(\s*)([/?])?", bygroups(Number.Integer, Whitespace, Operator)),
