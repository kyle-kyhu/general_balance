...
class WebIDLLexer(RegexLexer):
    ...
    tokens = {
        ...
        "type": [
            include("common"),
            (r"(?:" + r"|".join(_builtin_types) + r")" + _keyword_suffix, Keyword.Type, "type_null"),
            (words(("sequence", "Promise", "FrozenArray"), suffix=_keyword_suffix), Keyword.Type, "type_identifier"),
        ...
        "type_identifier": [(r"<", Punctuation, "type_list"), default(("#pop", "type_null"))],
        "type_null": [
            (r"\?", Punctuation),
            default("#pop:2"),
        ],
        ...
        "const_value": [
            include("common"),
            (
                words(("true", "false", "-Infinity", "Infinity", "NaN", "null"), suffix=_keyword_suffix),
                Keyword.Constant,
                "#pop",
            ),
            (
                r"-?(?:(?:[0-9]+\.[0-9]*|[0-9]*\.[0-9]+)(?:[Ee][+-]?[0-9]+)?" + r"|[0-9]+[Ee][+-]?[0-9]+)",
                Number.Float,
                "#pop",
            ),
        ...
        "serialization_pattern_map": [
            include("common"),
            (words(("getter", "inherit", "attribute"), suffix=_keyword_suffix), Keyword),
            (r",", Punctuation),
            (_identifier, Name.Variable),
            (r"\}", Punctuation, "#pop:2"),
        ],
