...
def _objdump_lexer_tokens(asm_lexer):
    ...
    return {
        "root": [
            # File name & format:
            ("(.*?)(:)( +file format )(.*?)$", bygroups(Name.Label, Punctuation, Text, String)),
            # Section header
            ("(Disassembly of section )(.*?)(:)$", bygroups(Text, Name.Label, Punctuation)),
            # Function labels
            # (With offset)
            (
                "(" + hex_re + "+)( )(<)(.*?)([-+])(0[xX][A-Za-z0-9]+)(>:)$",
                bygroups(Number.Hex, Whitespace, Punctuation, Name.Function, Punctuation, Number.Hex, Punctuation),
            ),
            # (Without offset)
            (
                "(" + hex_re + "+)( )(<)(.*?)(>:)$",
                bygroups(Number.Hex, Whitespace, Punctuation, Name.Function, Punctuation),
            ),
            # Code line with disassembled instructions
            (
                "( *)(" + hex_re + r"+:)(\t)((?:" + hex_re + hex_re + " )+)( *\t)([a-zA-Z].*?)$",
                bygroups(Whitespace, Name.Label, Whitespace, Number.Hex, Whitespace, using(asm_lexer)),
            ),
            ...
            (
                r"(\t\t\t)(" + hex_re + r"+:)( )([^\t]+)(\t)(.*?)$",
                bygroups(Whitespace, Name.Label, Whitespace, Name.Property, Whitespace, Name.Constant),
            ),
            (r"[^\n]+\n", Other),
        ]
    }
...
class LlvmMirBodyLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                words(
                    ("oeq", "one", "ogt", "oge", "olt", "ole", "ugt", "uge", "ult", "ule"),
                    prefix=r"floatpred\(",
                    suffix=r"\)",
                ),
                Name.Builtin,
...
class LlvmMirLexer(RegexLexer):
    ...
    tokens = {
        ...
        "llvm_mir": [
            ...
            (
                words(
                    ("legalized", "regBankSelected", "tracksRegLiveness", "selected", "exposesReturnsTwice"), suffix=":"
                ),
                Keyword,
                "boolean",
            ),
            ...
            (
                words(("registers", "stack", "fixedStack", "liveins", "frameInfo", "machineFunctionInfo"), suffix=":"),
                Keyword,
            ),
...
class Dasm16Lexer(RegexLexer):
    ...
    tokens = {
        ...
        "deref": [(r"\+", Punctuation), (r"\]", Punctuation, "#pop"), include("arg"), include("whitespace")],
        "instruction-line": [(r"[\r\n]+", Whitespace, "#pop"), (r";.*?$", Comment, "#pop"), include("whitespace")],
        "instruction-args": [
            (r",", Punctuation),
            (r"\[", Punctuation, "deref"),
            include("arg"),
        ...
        "data-args": [(r",", Punctuation), include("numeric"), (string, String), include("instruction-line")],
