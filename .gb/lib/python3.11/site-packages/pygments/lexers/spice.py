...
class SpiceLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                words(("const", "signed", "unsigned", "inline", "public", "heap", "compose"), suffix=r"\b"),
                Keyword.Pseudo,
            ),
            (words(("new", "yield", "stash", "pick", "sync", "class"), suffix=r"\b"), Keyword.Reserved),
            (r"(true|false|nil)\b", Keyword.Constant),
            (
                words(("double", "int", "short", "long", "byte", "char", "string", "bool", "dyn"), suffix=r"\b"),
                Keyword.Type,
            ),
            (
