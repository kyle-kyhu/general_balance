    ...
    * ``DEBUG.EXE FILE.COM`` and entering ``d`` to the prompt.
    ...
    tokens = {
        "root": [
            ...
            (hd + r"{2}", Number.Hex),
            (r"(\s{2,3})(\>)(.{16})(\<)$", bygroups(Whitespace, Punctuation, String, Punctuation), "bracket-strings"),
            (r"(\s{2,3})(\|)(.{16})(\|)$", bygroups(Whitespace, Punctuation, String, Punctuation), "piped-strings"),
            (r"(\s{2,3})(\>)(.{1,15})(\<)$", bygroups(Whitespace, Punctuation, String, Punctuation)),
            (r"(\s{2,3})(\|)(.{1,15})(\|)$", bygroups(Whitespace, Punctuation, String, Punctuation)),
        ...
        "offset-mode": [(r"\s", Whitespace, "#pop"), (hd + "+", Name.Label), (r":", Punctuation)],
        "piped-strings": [
            (r"\n", Whitespace),
            include("offset"),
            (hd + r"{2}", Number.Hex),
            (r"(\s{2,3})(\|)(.{1,16})(\|)$", bygroups(Whitespace, Punctuation, String, Punctuation)),
            (r"\s", Whitespace),
            (r"^\*", Punctuation),
        ],
        "bracket-strings": [
