...
class HamlLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "plain": [
            (r"([^#\n]|#[^{\n]|(\\\\)*\\#\{)+", Text),
            (r"(#\{)(" + _dot + r"*?)(\})", bygroups(String.Interpol, using(RubyLexer), String.Interpol)),
            (r"\n", Text, "root"),
        ],
        "html-attributes": [
            (r"\s+", Text),
...
class ScamlLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "content": [
            ...
            (r"(-)(" + _dot + r"*\n)", bygroups(Punctuation, using(ScalaLexer)), "#pop"),
            (r":" + _dot + r"*\n", _starts_block(Name.Decorator, "filter-block"), "#pop"),
            include("eval-or-plain"),
        ],
        "tag": [
        ...
        "plain": [
            (r"([^#\n]|#[^{\n]|(\\\\)*\\#\{)+", Text),
            (r"(#\{)(" + _dot + r"*?)(\})", bygroups(String.Interpol, using(ScalaLexer), String.Interpol)),
            (r"\n", Text, "root"),
        ],
        "html-attributes": [
            (r"\s+", Text),
