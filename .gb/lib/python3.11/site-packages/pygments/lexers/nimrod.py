...
class NimrodLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(proc|func|method|macro|template)(\s)(?![(\[\]])", bygroups(Keyword, Text.Whitespace), "funcname"),
            (rf"({underscorize(keywords)})\b", Keyword),
            (r"({})\b".format(underscorize(["from", "import", "include", "export"])), Keyword.Namespace),
            ...
            # Numbers
            (r"[0-9][0-9_]*(?=([e.]|\'f(32|64)))", Number.Float, ("float-suffix", "float-number")),
        ...
        "rdqs": [(r'"(?!")', String, "#pop"), (r'""', String.Escape), include("strings")],
        "tdqs": [(r'"""', String.Double, "#pop"), include("strings"), (r"\n", String.Double)],
        "funcname": [
        ...
        "int-suffix": [(r"\'i(32|64)", Number.Integer.Long), (r"\'i(8|16)", Number.Integer), default("#pop")],
        "casebranch": [
            (r",", Punctuation),
            (r"[\n ]+", Text.Whitespace),
            (r":", Operator, "#pop"),
