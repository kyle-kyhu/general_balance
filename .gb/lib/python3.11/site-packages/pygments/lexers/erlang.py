...
class ErlangLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            ("(?:^|(?<=:))(" + atom_re + r")(\s*)(\()", bygroups(Name.Function, Whitespace, Punctuation)),
...
class ElixirLexer(RegexLexer):
    ...
    def gen_elixir_sigil_rules():
        ...
        for term, name in triquotes:
            states["sigils"] += [
                (rf"(~[a-z])({term})", bygroups(token, String.Heredoc), (name + "-end", name + "-intp")),
                (rf"(~[A-Z])({term})", bygroups(token, String.Heredoc), (name + "-end", name + "-no-intp")),
            ]
    ...
    tokens = {
        "root": [
            ...
            (r"(\?)" + long_hex_char_re, bygroups(String.Char, String.Escape, Number.Hex, String.Escape)),
