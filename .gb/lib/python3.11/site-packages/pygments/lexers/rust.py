...
class RustLexer(RegexLexer):
    ...
    tokens = {
        ...
        "base": [
            ...
            # Labels
            (r"(break|continue)(\b\s*)(\'[A-Za-z_]\w*)?", bygroups(Keyword, Text.Whitespace, Name.Label)),
            # Character literals
            (r"""'(\\['"\\nrt]|\\x[0-7][0-9a-fA-F]|\\0""" r"""|\\u\{[0-9a-fA-F]{1,6}\}|.)'""", String.Char),
            (r"""b'(\\['"\\nrt]|\\x[0-9a-fA-F]{2}|\\0""" r"""|\\u\{[0-9a-fA-F]{1,6}\}|.)'""", String.Char),
            # Binary literals
            ...
            # Decimal literals
            (
                r"[0-9][0-9_]*(\.[0-9_]+[eE][+\-]?[0-9_]+|" r"\.[0-9_]*(?!\.)|[eE][+\-]?[0-9_]+)",
                Number.Float,
                "number_lit",
            ),
        ...
        "string": [
            (r'"', String, "#pop"),
            (r"""\\['"\\nrt]|\\x[0-7][0-9a-fA-F]|\\0""" r"""|\\u\{[0-9a-fA-F]{1,6}\}""", String.Escape),
            (r'[^\\"]+', String),
            (r"\\", String),
        ],
        "bytestring": [
