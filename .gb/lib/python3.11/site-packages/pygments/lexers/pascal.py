        ...
        while not scanner.eos:
            ...
            if stack[-1] == "initial":
                if scanner.scan(r"\s+"):
                    ...
                    elif not self.is_portugol and in_function_block and lowercase_name in self.FUNCTION_MODIFIERS:
                        token = Keyword.Pseudo
                    # if we are in a property highlight some more
                    # modifiers
                    elif not self.is_portugol and in_property_block and lowercase_name in ("read", "write"):
                        token = Keyword.Pseudo
                        next_token_is_function = True
