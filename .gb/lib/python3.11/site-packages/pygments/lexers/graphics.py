...
from pygments.token import Text, Comment, Operator, Keyword, Name, Number, Punctuation, String, Whitespace
...
class HLSLShaderLexer(RegexLexer):
    ...
    tokens = {
        ...
        "string": [
            (r'"', String, "#pop"),
            (r'\\([\\abfnrtv"\']|x[a-fA-F0-9]{2,4}|' r"u[a-fA-F0-9]{4}|U[a-fA-F0-9]{8}|[0-7]{1,3})", String.Escape),
...
class PostScriptLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"[0-9]+\#(\-|\+)?([0-9]+\.?|[0-9]*\.[0-9]+|[0-9]+\.[0-9]*)" r"((e|E)[0-9]+)?" + delimiter_end,
                Number.Oct,
            ),
            (r"(\-|\+)?([0-9]+\.?|[0-9]*\.[0-9]+|[0-9]+\.[0-9]*)((e|E)[0-9]+)?" + delimiter_end, Number.Float),
            ...
            (r"(eq|ne|g[et]|l[et]|and|or|not|if(?:else)?|for(?:all)?)" + delimiter_end, Keyword.Reserved),
            (
                words(
                    (
                        "abs",
...
class GnuplotLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (_shortened_many("pwd$", "re$read", "res$et", "scr$eendump", "she$ll", "test$"), Keyword, "noargs"),
            (r"([a-zA-Z_]\w*)(\s*)(=)", bygroups(Name.Variable, Whitespace, Operator), "genericargs"),
            (
                r"([a-zA-Z_]\w*)(\s*)(\()(.*?)(\))(\s*)(=)",
                bygroups(Name.Function, Whitespace, Punctuation, Text, Punctuation, Whitespace, Operator),
                "genericargs",
            ),
        ...
        "save": [
            (_shortened_many("f$unctions", "s$et", "t$erminal", "v$ariables"), Name.Builtin),
            include("genericargs"),
        ],
    }
