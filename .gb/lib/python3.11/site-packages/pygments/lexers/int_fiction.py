...
class Inform6Lexer(RegexLexer):
    ...
    tokens = {
        "root": [(rf"\A(!%[^{_newline}]*[{_newline}])+", Comment.Preproc, "directive"), default("directive")],
        ...
        "expression": [
            ...
            (rf"&&?|\|\|?|[=~><]?=|[{_dash}]{{1,2}}>?|\.\.?[&#]?|::|[<>+*/%]", Operator, "_expression"),
            (r"(has|hasnt|in|notin|ofclass|or|provides)\b", Operator.Word, "_expression"),
            (r"sp\b", Name),
            (r"\?~?", Name.Label, "label?"),
            (r"[@{]", Error),
            default("#pop"),
        ...
        "_for-expression": [(r"\)", Punctuation, "#pop:2"), (r":", Punctuation, "#pop"), include("expression")],
        "_keyword-expression": [(r"(from|near|to)\b", Keyword, "_expression"), include("expression")],
        "_list-expression": [(r",", Punctuation, "#pop"), include("expression")],
        "_object-expression": [(r"has\b", Keyword.Declaration, "#pop"), include("_list-expression")],
        # Values
        "value": [
            include("_whitespace"),
            # Strings
            ...
            (rf"([{_squote}])(@.{{2}})([{_squote}])", bygroups(String.Char, String.Escape, String.Char), "#pop"),
            (rf"[{_squote}]", String.Single, ("#pop", "dictionary-word")),
            (rf"[{_dquote}]", String.Double, ("#pop", "string")),
            # Numbers
            (rf"\$[<>]?[+{_dash}][0-9]*\.?[0-9]*([eE][+{_dash}]?[0-9]+)?", Number.Float, "#pop"),
        ...
        # Names
        "_constant": [include("_whitespace"), (_name, Name.Constant, "#pop"), include("value")],
        "constant*": [
            include("_whitespace"),
            (r",", Punctuation),
            (r"=", Punctuation, "value?"),
        ...
        "_global": [include("_whitespace"), (_name, Name.Variable.Global, "#pop"), include("value")],
        "label?": [include("_whitespace"), (_name, Name.Label, "#pop"), default("#pop")],
        "variable?": [include("_whitespace"), (_name, Name.Variable, "#pop"), default("#pop")],
        # Values after hashes
        ...
        "directive": [
            ...
            (r"(?i)(array|global)\b", Keyword, ("default", "directive-keyword?", "_global")),
            ...
            (r"(?i)(include|link|origsource)\b", Keyword, ("default", "before-plain-string?")),
            ...
            (r"(?i)property\b", Keyword, ("default", "alias?", "_constant", "property-keyword*")),
            ...
            (r"(?i)zcharacter\b", Keyword, ("default", "directive-keyword?", "directive-keyword?")),
            (_name, Name.Class, ("object-body", "_object-head")),
        ],
        # [, Replace, Stub
        "routine-name?": [include("_whitespace"), (_name, Name.Function, "#pop"), default("#pop")],
        "locals": [
            include("_whitespace"),
            (r";", Punctuation, "#pop"),
            (r"\*", Punctuation),
        ...
        # Attribute, Property
        "alias?": [include("_whitespace"), (r"alias\b", Keyword, ("#pop", "_constant")), default("#pop")],
        # Class, Object, Nearby
        "class-name": [
            include("_whitespace"),
        ...
        "=routine": [include("_whitespace"), (r"=", Punctuation, "routine-name?"), default("#pop")],
        # Import
        "manifest": [
            include("_whitespace"),
            (r";", Punctuation, "#pop"),
        ...
        "property-keyword*": [
            ...
            (
                words(
                    ("additive", "individual", "long"), suffix=rf"\b(?=(\s*|(![^{_newline}]*[{_newline}]))*[_a-zA-Z])"
                ),
                Keyword,
            ),
            default("#pop"),
        ...
        "miscellaneous-keyword?": [
            include("_whitespace"),
            (r"(bold|fixed|from|near|off|on|reverse|roman|to|underline)\b", Keyword, "#pop"),
            (
        ...
        "form": [include("_whitespace"), (r"\(", Punctuation, ("#pop", "miscellaneous-keyword?")), default("#pop")],
        # Assembly
        "opcode": [
            include("_whitespace"),
    ...
    for level in token_variants:
        tokens[level] = {
            ...
            "root": [
                ...
                (rf"[{_dquote}]", Generic.Heading, ("+main", "+titling", "+titling-string")),
                default(("+main", "+heading?")),
            ],
            "+titling-string": [(rf"[^{_dquote}]+", Generic.Heading), (rf"[{_dquote}]", Generic.Heading, "#pop")],
            "+titling": [
                (r"\[", Comment.Multiline, "+comment"),
                (rf"[^{_dquote}.;:|{_newline}]+", Generic.Heading),
                (rf"[{_dquote}]", Generic.Heading, "+titling-string"),
                (rf"[{_newline}]{{2}}|(?<=[\s{_dquote}])\|[\s{_dquote}]", Text, ("#pop", "+heading?")),
            ...
            "+main": [
                ...
                (
                    rf"(\([{_dash}])(.*?)([{_dash}]\))",
                    bygroups(
                        Punctuation, using(this, state=("+i6-root", "directive"), i6t="+i6t-not-inline"), Punctuation
                    ),
                ),
            ...
            "+phrase-definition": [
                ...
                (
                    ...
                    bygroups(
                        Punctuation,
                        using(this, state=("+i6-root", "directive", "default", "statements"), i6t="+i6t-inline"),
                        Punctuation,
                    ),
                    "#pop",
                ),
            ...
            "+use-option": [
                ...
                (
                    rf"(\([{_dash}])(.*?)([{_dash}]\))",
                    bygroups(
                        Punctuation, using(this, state=("+i6-root", "directive"), i6t="+i6t-use-option"), Punctuation
                    ),
                    "#pop",
                ),
                default("#pop"),
            ...
            "+heading?": [
                ...
                (rf"[{_dash}]{{1,3}}", Text),
                (rf"(?i)(volume|book|part|chapter|section)\b[^{_newline}]*", Generic.Heading, "#pop"),
                default("#pop"),
            ],
            ...
            "+i6t-use-option": [include("+i6t-not-inline"), (r"(\{)(N)(\})", bygroups(Punctuation, Text, Punctuation))],
            "+i6t-inline": [(r"(\{)(\S[^}]*)?(\})", bygroups(Punctuation, using(this, state="+main"), Punctuation))],
            "+i6t": [
                (rf"(\{{[{_dash}])(![^}}]*)(\}}?)", bygroups(Punctuation, Comment.Single, Punctuation)),
                (
                    rf"(\{{[{_dash}])(lines)(:)([^}}]*)(\}}?)",
                ...
                (r"(\(\+)(.*?)(\+\)|\Z)", bygroups(Punctuation, using(this, state="+main"), Punctuation)),
            ],
            "+p": [
                (r"[^@]+", Comment.Preproc),
            ...
            "+lines": [
                ...
                (rf"(\{{)([{_dash}]endlines)(\}})", bygroups(Punctuation, Keyword, Punctuation), "#pop"),
                (rf"[^@!{{]+?([{_newline}]|\Z)|.", Text),
            ],
        }
...
class Tads3Lexer(RegexLexer):
    ...
    _escape = r'(?:\\(?:[\n\\<>"\'^v bnrt]|u[\da-fA-F]{,4}|x[\da-fA-F]{,2}|' r"[0-3]?[0-7]{1,2}))"
    _name = r"(?:[_a-zA-Z]\w*)"
    _no_quote = r"(?=\s|\\?>)"
    _operator = r"(?:&&|\|\||\+\+|--|\?\?|::|[.,@\[\]~]|" r"(?:[=+\-*/%!&|^]|<<?|>>?>?)=?)"
    ...
    def _make_string_state(triple, double, verbatim=None, _escape=_escape):
        ...
        state = []
        if triple:
            state += [(rf"{char}{{3,}}", token, "#pop"), (rf"\\{char}+", String.Escape), (char, token)]
        else:
        ...
        if verbatim:
            ...
            state += [
                ...
                (r"(?i)\\?<listing(?=[\s=>]|\\>)", Name.Tag, ("#pop", f"{prefix}qs/listing", tag_state_name)),
                (r"(?i)\\?<xmp(?=[\s=>]|\\>)", Name.Tag, ("#pop", f"{prefix}qs/xmp", tag_state_name)),
                (rf"\\?<([^\s=><\\{char}]|<(?!<)|\\{char}{escaped_quotes}|{_escape}|\\.)*", Name.Tag, tag_state_name),
                include("s/entity"),
            ]
        state += [
            include("s/escape"),
    ...
    def _make_attribute_value_state(terminator, host_triple, host_double, _escape=_escape):
        token = String.Double if terminator == r'"' else String.Single if terminator == r"'" else String.Other
        ...
        return [
            ...
            (r"{}{}".format(r"" if token is String.Other else r"\\?", terminator), token, "#pop"),
            include("s/verbatim"),
            include("s/entity"),
    ...
    tokens = {
        ...
        "main/root": [include("main/basic"), default(("#pop", "object-body/no-braces", "classes", "class"))],
        ...
        "block?": [(r"\{", Punctuation, ("#pop", "block")), include("whitespace"), default("#pop")],
        "block/basic": [
            (r"[;:]+", Punctuation),
            (r"\{", Punctuation, "#push"),
            (r"\}", Punctuation, "#pop"),
            (r"default\b", Keyword.Reserved),
            (rf"({_name})({_ws}*)(:)", bygroups(Name.Label, using(this, state="whitespace"), Punctuation)),
            include("whitespace"),
        ],
        ...
        "main/basic": [
            ...
            (r"\{", Punctuation, ("#pop", "more/inner", "main/inner", "more/parameters", "main/parameters")),
            (r"\*|\.{3}", Punctuation, "#pop"),
            (r"(?i)0x[\da-f]+", Number.Hex, "#pop"),
            (r"(\d+\.(?!\.)\d*|\.\d+)([eE][-+]?\d+)?|\d+[eE][-+]?\d+", Number.Float, "#pop"),
            ...
            (rf"(new)({_ws}+(?=(?:function|method)\b))", bygroups(Keyword.Reserved, using(this, state="whitespace"))),
            (
            ...
            # Keywords
            (r"(argcount|definingobj|invokee|replaced|targetobj|targetprop)\b", Name.Builtin, "#pop"),
            ...
            (r"(for|foreach)\b", Keyword.Reserved, ("#pop", "more/inner", "main/inner")),
            (r"(function|method)\b", Keyword.Reserved, ("#pop", "block?", "function-name")),
            (r"grammar\b", Keyword.Reserved, ("#pop", "object-body/no-braces", "grammar")),
        ...
        "more/basic": [
            ...
            (rf"(is|not)({_ws}+)(in\b)", bygroups(Operator.Word, using(this, state="whitespace"), Operator.Word)),
            (r'[^\s!"%-_a-z{-~]+', Error),  # Averts an infinite loop
        ],
        ...
        # Parameter list
        "main/parameters": [
            (rf"({_name})({_ws}*)(?=:)", bygroups(Name.Variable, using(this, state="whitespace")), "#pop"),
            (
                rf"({_name})({_ws}+)({_name})",
        ...
        "more/parameters": [
            (rf"(:)({_ws}*(?=[?=,:)]))", bygroups(Punctuation, using(this, state="whitespace"))),
            (r"[?\]]+", Punctuation),
        ...
        "multimethod?": [(r"multimethod\b", Keyword, "#pop"), include("whitespace"), default("#pop")],
        # Statements and expressions
        "more/__objref": [(r",", Punctuation, "mode"), (r"\)", Operator, "#pop"), include("more")],
        "mode": [(r"(error|warn)\b", Keyword, "#pop"), include("whitespace")],
        "catch": [(r"\(+", Punctuation), (_name, Name.Exception, ("#pop", "variables")), include("whitespace")],
        "enum": [include("whitespace"), (r"token\b", Keyword, ("#pop", "constants")), default(("#pop", "constants"))],
        "grammar": [
            (r"\)+", Punctuation),
        ...
        "grammar-rules": [
            include("string"),
            include("whitespace"),
            (rf"(\[)({_ws}*)(badness)", bygroups(Punctuation, using(this, state="whitespace"), Keyword), "main"),
        ...
        "dqr": [(r'[^\\"]+', String.Regex), (r'\\"?', String.Regex), (r'"', String.Regex, "#pop")],
        "sqr": [(r"[^\\']+", String.Regex), (r"\\'?", String.Regex), (r"'", String.Regex, "#pop")],
    }
    ...
    def get_tokens_unprocessed(self, text, **kwargs):
        ...
        for index, token, value in RegexLexer.get_tokens_unprocessed(self, text, **kwargs):
            if if_false_level == 0:  # Not in a false #if
                if token is Comment.Preproc and re.match(rf"{pp}if{self._ws_pp}+(0|nil){self._ws_pp}*$\n?", value):
                    if_false_level = 1
            else:  # In a false #if
