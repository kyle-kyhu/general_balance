...
class MCFunctionLexer(RegexLexer):
    ...
    tokens = {
        ...
        "comments": [
            (rf"^\s*(#{_block_comment_prefix})", Comment.Multiline, ("comments.block", "comments.block.emphasized")),
            (r"#.*$", Comment.Single),
        ],
        "comments.block": [
...
class MCSchemaLexer(RegexLexer):
    ...
    tokens = {
        "commentsandwhitespace": [(r"\s+", Whitespace), (r"//.*?$", Comment.Single), (r"/\*.*?\*/", Comment.Multiline)],
        "slashstartsregex": [
