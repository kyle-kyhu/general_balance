...
class DarcsPatchLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(\[)((?:TAG )?)(.*)(\n)(.*)(\*\*)(\d+)(\s?)(\])",
                bygroups(Operator, Keyword, Name, Whitespace, Name, Operator, Literal.Date, Whitespace, Operator),
            ),
            (
                r"(\[)((?:TAG )?)(.*)(\n)(.*)(\*\*)(\d+)(\s?)",
                bygroups(Operator, Keyword, Name, Whitespace, Name, Operator, Literal.Date, Whitespace),
                "comment",
            ),
            (r"New patches:", Generic.Heading),
            (r"Context:", Generic.Heading),
            (r"Patch bundle hash:", Generic.Heading),
            (r"(\s*)({})(.*)(\n)".format("|".join(DPATCH_KEYWORDS)), bygroups(Whitespace, Keyword, Text, Whitespace)),
