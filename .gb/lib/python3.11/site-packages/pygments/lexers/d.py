...
class DLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # FloatLiteral
            # -- HexFloat
            (r"0[xX]([0-9a-fA-F_]*\.[0-9a-fA-F_]+|[0-9a-fA-F_]+)" r"[pP][+\-]?[0-9_]+[fFL]?[i]?", Number.Float),
            # -- DecimalFloat
            (r"[0-9_]+(\.[0-9_]+[eE][+\-]?[0-9_]+|" r"\.[0-9_]*|[eE][+\-]?[0-9_]+)[fFL]?[i]?", Number.Float),
            ...
            (r'"(\\\\|\\[^\\]|[^"\\])*"[cwd]?', String),
            # -- EscapeSequence
            (r"\\(['\"?\\abfnrtv]|x[0-9a-fA-F]{2}|[0-7]{1,3}" r"|u[0-9a-fA-F]{4}|U[0-9a-fA-F]{8}|&\w+;)", String),
            # -- HexString
...
class CrocLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # CharacterLiteral
            (
                r"""'(\\['"\\nrt]|\\x[0-9a-fA-F]{2}|\\[0-9]{1,3}""" r"""|\\u[0-9a-fA-F]{4}|\\U[0-9a-fA-F]{8}|.)'""",
                String.Char,
            ),
            # StringLiteral
            # -- WysiwygString
