...
class AwkLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            include("commentsandwhitespace"),
            (r"\+\+|--|\|\||&&|in\b|\$|!?~|\?|:|" r"(\*\*|[-<>+*%\^/!=|])=?", Operator, "slashstartsregex"),
            (r"[{(\[;,]", Punctuation, "slashstartsregex"),
            (r"[})\].]", Punctuation),
            (r"(break|continue|do|while|exit|for|if|else|" r"return)\b", Keyword, "slashstartsregex"),
...
class SedLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(\\(.))" + _inside_delims + r"(\2)", bygroups(Punctuation, None, String.Regex, Punctuation)),
            (
            ...
            (
                ...
                bygroups(Keyword, Punctuation, String.Regex, Punctuation, String.Single, Punctuation, Keyword),
            ),
        ]
    }
...
class VimLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"^([ \t:]*)(" + _python + r")([ \t])(.*)", bygroups(using(this), Keyword, Text, using(PythonLexer))),
            (r'^\s*".*', Comment),
            (r"[ \t]+", Text),
