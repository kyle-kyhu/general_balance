...
class NSISLexer(RegexLexer):
    ...
    tokens = {
        ...
        "basic": [
            (r"(\n)(Function)(\s+)([._a-z][.\w]*)\b", bygroups(Whitespace, Keyword, Whitespace, Name.Function)),
            (r"\b([_a-z]\w*)(::)([a-z][a-z0-9]*)\b", bygroups(Keyword.Namespace, Punctuation, Name.Function)),
...
class DebianControlLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"^((?:Build-|Pre-)?Depends(?:-Indep|-Arch)?)(:\s*)", bygroups(Keyword, Text), "depends"),
            (r"^(Recommends|Suggests|Enhances)(:\s*)", bygroups(Keyword, Text), "depends"),
            ...
            (r"^([a-zA-Z\-0-9\.]*?)(:\s*)(.*?)$", bygroups(Keyword, Whitespace, String)),
        ],
        "maintainer": [
        ...
        "depends": [
            (r"(\$)(\{)(\w+\s*:\s*\w+)(\})", bygroups(Operator, Text, Name.Entity, Text)),
            (r"\(", Text, "depend_vers"),
            (r"\|", Operator),
            (r",\n", Text),
            (r"\n", Text, "#pop"),
