...
class BlueprintLexer(RegexLexer):
    ...
    tokens = {
        ...
        "content": [
            ...
            # Translated strings
            (r"(C?_)(\s*)(\()", bygroups(Name.Function.Builtin, Whitespace, Punctuation), "paren-content"),
            # Cast expressions
            (r"(as)(\s*)(<)", bygroups(Keyword, Whitespace, Punctuation), "typeof"),
            # Closures
            (r"(\$?[a-z_][a-z0-9_\-]*)(\s*)(\()", bygroups(Name.Function, Whitespace, Punctuation), "paren-content"),
            # Objects
            (
        ...
        "block-content": [
            ...
            (
                ...
                bygroups(Keyword, Whitespace, Name.Namespace, Whitespace, Name.Namespace, Punctuation),
            ),
            # Menus
            (
            ...
            (r"(item)(\s*)(\{)", bygroups(Keyword, Whitespace, Punctuation), "brace-block"),
            (r"(item)(\s*)(\()", bygroups(Keyword, Whitespace, Punctuation), "paren-block"),
            # Templates
            ...
            (r"(condition|mark|item)(\s*)(\()", bygroups(Keyword, Whitespace, Punctuation), "paren-content"),
        ...
        "child-type": [
            ...
            (
                ...
                bygroups(Keyword, Whitespace, Name.Attribute, Whitespace, Punctuation, Whitespace),
            ),
