...
class UniconLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(record)(\s+)(\w+)", bygroups(Keyword.Declaration, Text, Keyword.Type), "type_def"),
            (
                r"(#line|\$C|\$Cend|\$define|\$else|\$endif|\$error|\$ifdef|" r"\$ifndef|\$include|\$line|\$undef)\b",
                Keyword.PreProc,
            ),
...
class UcodeLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (words(("colm", "filen", "line", "synt"), prefix=r"\b", suffix=r"\b"), Comment),
            (
                words(
                    (
                        "asgn",
