...
class DuelLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            (r"(<%[@=#!:]?)(.*?)(%>)", bygroups(Name.Tag, using(JavascriptLexer), Name.Tag)),
            (r"(<%\$)(.*?)(:)(.*?)(%>)", bygroups(Name.Tag, Name.Function, Punctuation, String, Name.Tag)),
            (r"(<%--)(.*?)(--%>)", bygroups(Name.Tag, Comment.Multiline, Name.Tag)),
            (r"(<script.*?>)(.*?)(</script>)", bygroups(using(HtmlLexer), using(JavascriptLexer), using(HtmlLexer))),
            (r"(.+?)(?=<)", using(HtmlLexer)),
            (r".+", using(HtmlLexer)),
        ],
    }
...
class XQueryLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "operator": [
            ...
            (r"return|satisfies|to|union|where|count|preserve\s+strip", Keyword, "root"),
            (r"(>=|>>|>|<=|<<|<|-|\*|!=|\+|\|\||\||:=|=|!)", operator_root_callback),
            (r"(::|:|;|\[|//|/|,)", punctuation_root_callback),
            (r"(castable|cast)(\s+)(as)\b", bygroups(Keyword, Whitespace, Keyword), "singletype"),
            (r"(instance)(\s+)(of)\b", bygroups(Keyword, Whitespace, Keyword), "itemtype"),
            (r"(treat)(\s+)(as)\b", bygroups(Keyword, Whitespace, Keyword), "itemtype"),
            (r"(case)(\s+)(" + stringdouble + ")", bygroups(Keyword, Whitespace, String.Double), "itemtype"),
            (r"(case)(\s+)(" + stringsingle + ")", bygroups(Keyword, Whitespace, String.Single), "itemtype"),
            (r"(case|as)\b", Keyword, "itemtype"),
            (r"(\))(\s*)(as)", bygroups(Punctuation, Whitespace, Keyword), "itemtype"),
            (r"\$", Name.Variable, "varname"),
            (r"(for|let|previous|next)(\s+)(\$)", bygroups(Keyword, Whitespace, Name.Variable), "varname"),
            (
                r"(for)(\s+)(tumbling|sliding)(\s+)(window)(\s+)(\$)",
                bygroups(Keyword, Whitespace, Keyword, Whitespace, Keyword, Whitespace, Name.Variable),
                "varname",
            ),
            # (r'\)|\?|\]', Punctuation, '#push'),
            (r"\)|\?|\]", Punctuation),
        ...
        "namespacedecl": [
            include("whitespace"),
            (r"\(:", Comment, "comment"),
            (r"(at)(\s+)(" + stringdouble + ")", bygroups(Keyword, Whitespace, String.Double)),
            (r"(at)(\s+)(" + stringsingle + ")", bygroups(Keyword, Whitespace, String.Single)),
            (stringdouble, String.Double),
            (stringsingle, String.Single),
            (r",", Punctuation),
            (r"=", Operator),
        ...
        "itemtype": [
            ...
            (r"except|intersect|in|is|return|satisfies|to|union|where|count", Keyword, "root"),
        ...
        "root": [
            ...
            (r"(\.\.|\.|\))", Punctuation, "operator"),
            (r"(declare)(\s+)(construction)", bygroups(Keyword.Declaration, Text, Keyword.Declaration), "operator"),
            (
            ...
            (
                ...
                bygroups(Keyword.Declaration, Whitespace, Keyword.Declaration, Whitespace, Keyword.Declaration),
            ),
            (
            ...
            (r"(import)(\s+)(schema|module)", bygroups(Keyword.Pseudo, Whitespace, Keyword.Pseudo), "namespacekeyword"),
            (
            ...
            # VARNAMEs
            (r"(for|let|some|every)(\s+)(\$)", bygroups(Keyword, Whitespace, Name.Variable), "varname"),
            (
                r"(for)(\s+)(tumbling|sliding)(\s+)(window)(\s+)(\$)",
                bygroups(Keyword, Whitespace, Keyword, Whitespace, Keyword, Whitespace, Name.Variable),
                "varname",
            ...
            (
                ...
                bygroups(Keyword.Declaration, Whitespace, Keyword.Declaration, Whitespace, Name.Variable),
                "varname",
            ),
            # ANNOTATED GLOBAL VARIABLES AND FUNCTIONS
            (r"(declare)(\s+)(\%)", bygroups(Keyword.Declaration, Whitespace, Name.Decorator), "annotationname"),
            # ITEMTYPE
            ...
            (r"(element|attribute|namespace)(\s*)(\{)", pushstate_operator_root_construct_callback),
            (r"(document|text|processing-instruction|comment)(\s*)(\{)", pushstate_operator_root_construct_callback),
            # ATTRIBUTE
            (r"(attribute)(\s+)(?=" + qname + r")", bygroups(Keyword, Whitespace), "attribute_qname"),
            # ELEMENT
            (r"(element)(\s+)(?=" + qname + r")", bygroups(Keyword, Whitespace), "element_qname"),
            # PROCESSING_INSTRUCTION
            (
            ...
            (r"(declare|define)(\s+)(function)", bygroups(Keyword.Declaration, Whitespace, Keyword.Declaration)),
            (r"(\{|\[)", pushstate_operator_root_callback),
            ...
            (r"(xquery)(\s+)(version)", bygroups(Keyword.Pseudo, Whitespace, Keyword.Pseudo), "xqueryversion"),
            (r"(\(#)(\s*)", bygroups(Punctuation, Whitespace), "pragma"),
            # sometimes return can occur in root state
            (r"return", Keyword),
            (r"(declare)(\s+)(option)", bygroups(Keyword.Declaration, Whitespace, Keyword.Declaration), "option"),
            ...
            (
                r"(descendant|following-sibling|following|parent|preceding-sibling" r"|preceding|self)(::)",
                bygroups(Keyword, Punctuation),
            ),
            (r"(if)(\s*)(\()", bygroups(Keyword, Whitespace, Punctuation)),
            (r"then|else", Keyword),
            # eXist specific XQUF
            (r"(update)(\s*)(insert|delete|replace|value|rename)", bygroups(Keyword, Whitespace, Keyword)),
            (r"(into|following|preceding|with)", Keyword),
            # Marklogic specific
            (r"(try)(\s*)", bygroups(Keyword, Whitespace), "root"),
            (r"(catch)(\s*)(\()(\$)", bygroups(Keyword, Whitespace, Punctuation, Name.Variable), "varname"),
...
class SlimLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "plain": [
            (r"([^#\n]|#[^{\n]|(\\\\)*\\#\{)+", Text),
            (r"(#\{)(.*?)(\})", bygroups(String.Interpol, using(RubyLexer), String.Interpol)),
            (r"\n", Text, "root"),
        ],
        "html-attributes": [
            (r"=", Punctuation),
