...
class TactLexer(RegexLexer):
    ...
    tokens = {
        ...
        "const-declaration-in": [
            (
                r"(?=\b(?:(?:get|native|extends|mutates|virtual|override|inline|abstract)\s*)*const\b)",
                Keyword,
                "const-declaration",
            ),
        ],
        "const-declaration": [
            ...
            (
                words(
                    ("get", "native", "extends", "mutates", "virtual", "override", "inline", "abstract"), suffix=r"\b"
                ),
                Keyword,
            ),
        ...
        "init-declaration-in": [(r"(init)", Keyword, "init-declaration")],
        "init-declaration": [
            (r"(?<=\})", Punctuation, "#pop"),
            include("comments"),
        ...
        "receive-declaration-in": [(r"(receive|exernal)", Keyword, "receive-declaration")],
        "receive-declaration": [
            (r"(?<=\})", Punctuation, "#pop"),
            include("comments"),
            include("fun-arguments-in"),
        ...
        "bounce-declaration-in": [(r"(bounced)", Keyword, "bounce-declaration")],
        "bounce-declaration": [
            (r"(?<=\})", Punctuation, "#pop"),
            include("comments"),
            include("fun-arguments-in"),
        ...
        "fun-declaration-in": [
            (
                r"(?=\b(?:(?:get|native|extends|mutates|virtual|override|inline|abstract)\s*)*fun\b)",
                Keyword,
                "fun-declaration",
            )
        ],
        ...
        "block-declaration-in": [(r"\{", Punctuation, "block-declaration")],
        "block-declaration": [
            (r"\}", Punctuation, "#pop"),
            include("statements"),
        ],
        ...
        "annotation-in": [(r"(@)(\w+)(\()", bygroups(Keyword.Pseudo, Keyword, Punctuation), "annotation")],
        "annotation": [
            (r"\)", Punctuation, "#pop"),
        ...
        "struct-init-in": [(r"(\b\w+)(\s*)(\{)", bygroups(Name.Class, Whitespace, Punctuation), "struct-init")],
        "struct-init": [
            (r"(\})", Punctuation, "#pop"),
            include("comments"),
        ...
        "variable-init-in": [(r"(=)", Operator, "variable-init")],
        "variable-init": [
            (r"(?=\}|\{|\,|\;)", Punctuation, "#pop"),
            include("comments"),
            include("expressions"),
        ...
        "type-annotation-in": [(r"(:)(\s+)", bygroups(Punctuation, Whitespace), "type-annotation")],
        "type-annotation": [
            (r"(?=\{|\;|\=|\,|\))", Punctuation, "#pop"),
            include("comments"),
            include("type-as-in"),
        ...
        "variable": [(r"\b\w+\b(?!\s*\()(?!\s*\{)", Name.Variable)],
        "function-call": [(r"\b\w+\b(?=\s*\()(?!\s*\{)", Name.Function)],
    }
