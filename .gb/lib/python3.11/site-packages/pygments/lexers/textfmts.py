...
class GettextLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r'^".*"$', String),
            (r'^(msgid|msgid_plural|msgstr|msgctxt)(\s+)(".*")$', bygroups(Name.Variable, Text, String)),
            (r'^(msgstr\[)(\d)(\])(\s+)(".*")$', bygroups(Name.Variable, Number.Integer, Name.Variable, Text, String)),
        ]
    }
...
class HttpLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            (
                r"([a-zA-Z][-_a-zA-Z]+)( +)([^ ]+)( +)" r"(HTTP)(/)(1\.[01]|2(?:\.0)?|3)(\r?\n|\Z)",
...
class TodotxtLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (complete_two_date_regex, bygroups(CompleteTaskText, Date, CompleteTaskText, Date), "complete"),
            ...
            (priority_date_regex, bygroups(Priority, IncompleteTaskText, Date), "incomplete"),
            # 2. Priority only
...
class NotmuchLexer(RegexLexer):
    ...
    tokens = {
        ...
        "message-attr": [
            ...
            (r"(\s*(?:depth|match|excluded):\s*)(\d+)", bygroups(Name.Attribute, Number.Integer)),
        ...
        "part-attr": [
            ...
            (r"(,\s*)((?:Filename|Content-id):\s*)([^,]+)", bygroups(Punctuation, Name.Attribute, String)),
