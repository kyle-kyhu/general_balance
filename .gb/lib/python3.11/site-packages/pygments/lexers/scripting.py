...
class LuaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "base": [
            ...
            ("(break|do|else|elseif|end|for|if|in|repeat|return|then|until|" r"while)\b", Keyword.Reserved),
        ...
        "stringescape": [
            (r'\\([abfnrtv\\"\']|[\r\n]{1,2}|z\s*|x[0-9a-fA-F]{2}|\d{1,3}|' r"u\{[0-9a-fA-F]+\})", String.Escape),
        ],
        "sqs": [
            (r"'", String.Single, "#pop"),
            (r"[^\\']+", String.Single),
    ...
    tokens = {
        ...
        "base": [
            ...
            *_luau_make_expression_special(False),
            ...
            (
                words(("elseif", "for", "if", "in", "repeat", "return", "until", "while"), suffix=r"\b"),
                Keyword.Reserved,
                "expression",
            ),
        ...
        "string_escape": [
            (r"\\z\s*", String.Escape),
            (r'\\(?:[abfnrtvz\\"\'`\{\n])|[\r\n]{1,2}|x[\da-fA-F]{2}|\d{1,3}|' r"u\{\}[\da-fA-F]*\}", String.Escape),
        ],
        "string_single": [
        ...
        "type_start": [
            ...
            (r"'", String.Single, ("#pop", "string_single")),
            (r'"', String.Double, ("#pop", "string_double")),
            (r"typeof\(", Name.Builtin, ("#pop", "closing_parenthesis_base", "expression")),
...
class ChaiscriptLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"[})\].]", Punctuation),
            (r"[=+\-*/]", Operator),
            (r"(for|in|while|do|break|return|continue|if|else|" r"throw|try|catch" r")\b", Keyword, "slashstartsregex"),
...
class AppleScriptLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"^(\s*(?:on|end)\s+)" r"({})".format("|".join(StudioEvents[::-1])), bygroups(Keyword, Name.Function)),
...
class RexxLexer(RegexLexer):
    ...
    def analyse_text(text):
        ...
        if re.search(r"/\*\**\s*rexx", text, re.IGNORECASE):
            ...
            result = (
                sum(weight for (pattern, weight) in RexxLexer.PATTERNS_AND_WEIGHTS if pattern.search(lowerText)) + 0.01
            )
...
class HybrisLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            # method names
            (
                r"^(\s*(?:function|method|operator\s+)+?)" r"([a-zA-Z_]\w*)" r"(\s*)(\()",
            ...
            (r"(extends|private|protected|public|static|throws|function|method|" r"operator)\b", Keyword.Declaration),
            (r"(true|false|null|__FILE__|__LINE__|__VERSION__|__LIB_PATH__|" r"__INC_PATH__)\b", Keyword.Constant),
...
class EasytrieveLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(FILE|MACRO|REPORT)(\s+)", bygroups(Keyword.Declaration, Whitespace), "after_declaration"),
            (r"(JOB|PARM)" + r"(" + _DELIMITER_PATTERN + r")", bygroups(Keyword.Declaration, Operator)),
            (words(_KEYWORDS, suffix=_DELIMITER_PATTERN_CAPTURE), bygroups(Keyword.Reserved, Operator)),
...
class JclLexer(RegexLexer):
    ...
    tokens = {
        ...
        "statement_command": [
            (
                r"\s+(command|cntl|dd|endctl|endif|else|include|jcllib|" r"output|pend|proc|set|then|xmit)\s+",
                Keyword.Reserved,
                "option",
            ),
            include("option"),
        ...
        "jes2_statement": [
            ...
            (r"\$", Keyword, "option"),
            (
                r"\b(jobparam|message|netacct|notify|output|priority|route|" r"setup|signoff|xeq|xmit)\b",
                Keyword,
                "option",
            ),
        ],
