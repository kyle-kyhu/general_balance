...
from pygments.token import Text, Comment, Keyword, Name, String, Number, Whitespace
...
class ForthLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(:|variable|constant|value|buffer:)(\s+)", bygroups(Keyword.Namespace, Whitespace), "worddef"),
