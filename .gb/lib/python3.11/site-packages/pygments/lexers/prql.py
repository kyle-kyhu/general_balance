...
class PrqlLexer(RegexLexer):
    ...
    builtinTypes = words(
        ("bool", "int", "int8", "int16", "int32", "int64", "int128", "float", "text", "set"), suffix=r"\b"
    )
    ...
    tokens = {
        "root": [
            ...
            (r"\s+", Whitespace),
            # Modules
            (r"^(\s*)(module)(\s*)", bygroups(Whitespace, Keyword.Namespace, Whitespace), "imports"),
        ...
        "expr": [
            # non-raw f-strings
            ('(f)(""")', bygroups(String.Affix, String.Double), combined("fstringescape", "tdqf")),
            ("(f)(''')", bygroups(String.Affix, String.Single), combined("fstringescape", "tsqf")),
            ('(f)(")', bygroups(String.Affix, String.Double), combined("fstringescape", "dqf")),
            ("(f)(')", bygroups(String.Affix, String.Single), combined("fstringescape", "sqf")),
            # non-raw s-strings
            ('(s)(""")', bygroups(String.Affix, String.Double), combined("stringescape", "tdqf")),
            ("(s)(''')", bygroups(String.Affix, String.Single), combined("stringescape", "tsqf")),
            ('(s)(")', bygroups(String.Affix, String.Double), combined("stringescape", "dqf")),
            ("(s)(')", bygroups(String.Affix, String.Single), combined("stringescape", "sqf")),
            # raw strings
        ...
        "stringescape": [(r"\\(N\{.*?\}|u\{[a-fA-F0-9]{1,6}\})", String.Escape), include("bytesescape")],
