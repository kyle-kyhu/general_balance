...
class ZigLexer(RegexLexer):
    ...
    structure_keywords = (words(("struct", "enum", "union", "error"), suffix=r"\b"), Keyword)
    ...
    conditional_keywords = (words(("if", "else", "switch", "and", "or", "orelse"), suffix=r"\b"), Keyword)

    repeat_keywords = (words(("while", "for"), suffix=r"\b"), Keyword)

    other_keywords = (words(("fn", "usingnamespace", "test"), suffix=r"\b"), Keyword)

    constant_keywords = (words(("true", "false", "null", "undefined"), suffix=r"\b"), Keyword.Constant)
