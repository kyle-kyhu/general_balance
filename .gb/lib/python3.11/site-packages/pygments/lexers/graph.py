...
class CypherLexer(RegexLexer):
    ...
    tokens = {
        ...
        "keywords": [
            (
                r"(create|order|match|limit|set|skip|start|return|with|where|" r"delete|foreach|not|by|true|false)\b",
                Keyword,
            ),
        ],
        "clauses": [
            ...
            (r"(drop)(\s+)(contraint|index)(\s+)(on)\b", bygroups(Keyword, Whitespace, Keyword, Whitespace, Keyword)),
            (r"(ends)(\s+)(with)\b", bygroups(Keyword, Whitespace, Keyword)),
            (r"(is)(\s+)(node)(\s+)(key)\b", bygroups(Keyword, Whitespace, Keyword, Whitespace, Keyword)),
            (r"(is)(\s+)(null|unique)\b", bygroups(Keyword, Whitespace, Keyword)),
            (r"(load)(\s+)(csv)(\s+)(from)\b", bygroups(Keyword, Whitespace, Keyword, Whitespace, Keyword)),
            ...
            (r"(using)(\s+)(periodic)(\s+)(commit)\b", bygroups(Keyword, Whitespace, Keyword, Whitespace, Keyword)),
