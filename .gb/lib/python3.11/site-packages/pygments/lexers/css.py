...
class CssLexer(RegexLexer):
    ...
    tokens = {
        ...
        "content": [
            ...
            (r"([-]+[a-zA-Z_][\w-]*)(\s*)(\:)", bygroups(Name.Variable, Whitespace, Punctuation), "value-start"),
            (r"([a-zA-Z_][\w-]*)(\s*)(\:)", bygroups(Name, Whitespace, Punctuation), "value-start"),
            (r"/\*(?:.|\n)*?\*/", Comment),
        ],
        "value-start": [
            (r"\s+", Whitespace),
        ...
        "urls": [
            (r'(url)(\()(".*?")(\))', bygroups(Name.Builtin, Punctuation, String.Double, Punctuation)),
            (r"(url)(\()('.*?')(\))", bygroups(Name.Builtin, Punctuation, String.Single, Punctuation)),
            (r"(url)(\()(.*?)(\))", bygroups(Name.Builtin, Punctuation, String.Other, Punctuation)),
        ],
        "numeric-values": [
