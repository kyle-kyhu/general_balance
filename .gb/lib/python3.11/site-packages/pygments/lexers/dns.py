    ...
    tokens = {
        "root": [
            ...
            (
                ...
                bygroups(
                    Operator, Whitespace, Number.Integer, Whitespace, Name.Class, Whitespace, Keyword.Type, Whitespace
                ),
                "values",
            ),
            (
                ...
                bygroups(
                    Name, Whitespace, Number.Integer, Whitespace, Name.Class, Whitespace, Keyword.Type, Whitespace
                ),
                "values",
            ),
        ...
        "include": [
            (
                r"([ \t]+)([^ \t\n]+)([ \t]+)([-\._a-zA-Z]+)([ \t]+)(;.*)?$",
                bygroups(Whitespace, Comment.PreprocFile, Whitespace, Name, Whitespace, Comment.Single),
                "#pop",
            ),
