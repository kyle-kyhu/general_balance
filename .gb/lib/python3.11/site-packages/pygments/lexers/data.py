...
class YamlLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            # indentation spaces
            (r"[ ]*(?!\s|$)", save_indent(Whitespace, start=True), ("block-line", "indentation")),
        ],
        ...
        "block-line": [
            ...
            include("flow-nodes"),
            # a plain scalar
            (r'(?=[^\s?:,\[\]{}#&*!|>\'"%@`-]|[?:-]\S)', something(Name.Variable), "plain-scalar-in-block-context"),
        ],
        ...
        "block-nodes": [
            ...
            (r"[|>]", Punctuation.Indicator, ("block-scalar-content", "block-scalar-header")),
        ],
        # flow collections and quoted scalars
        "flow-nodes": [
            # a flow sequence
        ...
        "flow-collection": [
            ...
            include("flow-nodes"),
            # a plain scalar
            (r'(?=[^\s?:,\[\]{}#&*!|>\'"%@`])', something(Name.Variable), "plain-scalar-in-flow-context"),
        ],
        ...
        "block-scalar-header": [
            ...
            (r"([1-9])?[+-]?(?=[ ]|$)", set_block_scalar_indent(Punctuation.Indicator), "ignored-line"),
