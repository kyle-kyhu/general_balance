...
class CobolLexer(RegexLexer):
    ...
    tokens = {
        ...
        "core": [
            ...
            # Comparing Operators
            (
                r"(^|(?<=[^\w\-]))(equal|equals|ne|lt|le|gt|ge|" r"greater|less|than|not|and|or)\s*($|(?=[^\w\-]))",
                Operator.Word,
            ),
        ],
        # \"[^\"\n]*\"|\'[^\'\n]*\'
...
class ABAPLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"(CALL\s+(?:DIALOG|SCREEN|SUBSCREEN|SELECTION-SCREEN|" r"TRANSACTION|TRANSFORMATION))\b", Keyword),
            (r"(FORM|PERFORM)(\s+)(\w+)", bygroups(Keyword, Whitespace, Name.Function)),
            (r"(PERFORM)(\s+)(\()(\w+)(\))", bygroups(Keyword, Whitespace, Punctuation, Name.Variable, Punctuation)),
            (
            ...
            # method calls
            (r"(\s+)([\w\-]+)([=\-]>)([\w\-~]+)", bygroups(Whitespace, Name.Variable, Operator, Name.Function)),
...
class OpenEdgeLexer(RegexLexer):
    ...
    keywords = words(OPENEDGEKEYWORDS, prefix=r"(?i)(^|(?<=[^\w\-]))", suffix=r"\s*($|(?=[^\w\-]))")
...
class GoodDataCLLexer(RegexLexer):
    ...
    tokens = {
        ...
        "string-literal": [(r'\\[tnrfbae"\\]', String.Escape), (r'"', String, "#pop"), (r'[^\\"]+', String)],
    }
