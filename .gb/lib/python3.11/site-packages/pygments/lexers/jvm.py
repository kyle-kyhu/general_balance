    ...
    tokens = {
        "root": [
            (
                ...
                bygroups(Whitespace, using(this), Keyword.Declaration),
                "class",
            ),
            (r"[^\S\n]+", Whitespace),
            ...
            (r"(import(?:\s+static)?)(\s+)", bygroups(Keyword.Namespace, Whitespace), "import"),
        ...
        "class": [(r"\s+", Text), (r"([^\W\d]|\$)[\w$]*", Name.Class, "#pop")],
        "var": [(r"([^\W\d]|\$)[\w$]*", Name, "#pop")],
        "import": [(r"[\w.]+\*?", Name.Namespace, "#pop")],
        "multiline_string": [(r'"""', String, "#pop"), (r'"', String), include("string")],
        "string": [
            (r'[^\\"]+', String),
...
class ScalaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "exports": [
            (r"\b(export)(\s+)(given)(\s+)", bygroups(Keyword, Whitespace, Keyword, Whitespace), "export-path"),
        ...
        "declarations": [
            (rf"\b(def)\b(\s*){notStartOfComment}({anyId})?", bygroups(Keyword, Whitespace, Name.Function)),
            (rf"\b(trait)\b(\s*){notStartOfComment}({anyId})?", bygroups(Keyword, Whitespace, Name.Class)),
            (
                rf"\b(?:(case)(\s+))?(class|object|enum)\b(\s*){notStartOfComment}({anyId})?",
                bygroups(Keyword, Whitespace, Keyword, Whitespace, Name.Class),
            ),
            (rf"(?<!\.)\b(type)\b(\s*){notStartOfComment}({anyId})?", bygroups(Keyword, Whitespace, Name.Class)),
            ...
            (rf"\b(given)\b(\s*)({idUpper})", bygroups(Keyword, Whitespace, Name.Class)),
            (rf"\b(given)\b(\s*)({anyId})?", bygroups(Keyword, Whitespace, Name)),
        ],
        "inheritance": [
            (
                r"\b(extends|with|derives)\b(\s*)" rf'({idUpper}|{backQuotedId}|(?=\([^\)]+=>)|(?={plainid})|(?="))?',
        ...
        "end": [
            ...
            (r"\b(end)(\s+)(if|while|for|match|new|extension|val|var)\b", bygroups(Keyword, Whitespace, Keyword)),
            (rf"\b(end)(\s+)({idUpper}){endOfLineMaybeWithComment}", bygroups(Keyword, Whitespace, Name.Class)),
            (
        ...
        "constants": [
            ...
            (r"([0-9][0-9_]*\.[0-9][0-9_]*|\.[0-9][0-9_]*)" r"([eE][+-]?[0-9][0-9_]*)?[fFdD]?", Number.Float),
        ...
        "inline": [
            ...
            # match or parameters.
            (rf"\b(inline)(?=\s+({plainid}|{backQuotedId})\s*:)", Keyword),
        ...
        "interpolated-string-common": [
            (r'[^"$\\]+', String),
            (r"\$\$", String.Escape),
            (rf"(\$)({simpleInterpolatedVariable})", bygroups(String.Interpol, Name)),
    ...
    tokens = {
        "root": [
            ...
            (
                ...
                r"implements|represents|readonly)\b",
                Keyword.Declaration,
            ),
            (r"(property)(\s+)(get|set)?", bygroups(Keyword.Declaration, Whitespace, Keyword.Declaration)),
            (r"(boolean|byte|char|double|float|int|long|short|void|block)\b", Keyword.Type),
            ...
            (r"(uses)(\s+)([\w.]+\*?)", bygroups(Keyword.Namespace, Whitespace, Name.Namespace)),
            (r'"', String, "string"),
        ...
        "string": [(r'"', String, "#pop"), include("templateText")],
        "stringTemplate": [(r'"', String, "string"), (r"%>", Operator, "#pop"), include("root")],
...
class GroovyLexer(RegexLexer):
    ...
    tokens = {
        ...
        "base": [
            ...
            (r"(def|boolean|byte|char|double|float|int|long|short|void)\b", Keyword.Type),
            (r"(package)(\s+)", bygroups(Keyword.Namespace, Whitespace)),
            (r"(true|false|null)\b", Keyword.Constant),
            (r"(class|interface)(\s+)", bygroups(Keyword.Declaration, Whitespace), "class"),
...
class IokeLexer(RegexLexer):
    ...
    tokens = {
        "interpolatableText": [
            (r'(\\b|\\e|\\t|\\n|\\f|\\r|\\"|\\\\|\\#|\\\Z|\\u[0-9a-fA-F]{1,4}' r"|\\[0-3]?[0-7]?[0-7])", String.Escape),
            (r"#\{", Punctuation, "textInterpolationRoot"),
        ],
        "text": [(r'(?<!\\)"', String, "#pop"), include("interpolatableText"), (r'[^"]', String)],
        "documentation": [(r'(?<!\\)"', String.Doc, "#pop"), include("interpolatableText"), (r'[^"]', String.Doc)],
        "textInterpolationRoot": [(r"\}", Punctuation, "#pop"), include("root")],
        "slashRegexp": [
        ...
        "squareText": [(r"(?<!\\)]", String, "#pop"), include("interpolatableText"), (r"[^\]]", String)],
        "root": [
            (r"\n", Whitespace),
            (r"\s+", Whitespace),
            # Comments
            ...
            (
                r"(case|case:and|case:else|case:nand|case:nor|case:not|case:or|" r"case:otherwise|case:xor)(?![\w!:?])",
                Keyword.Reserved,
            ),
            ...
            # DefaultBehaviour
            (r"(kind|cellDescriptionDict|cellSummary|genSym|inspect|notice)" r"(?![\w!:?])", Keyword),
            ...
            (r"(and|nand|or|xor|nor|return|import)(?![\w!?])", Operator),
            # Punctuation
            (r"(\`\`|\`|\'\'|\'|\.|\,|@@|@|\[|\]|\(|\)|\{|\})", Punctuation),
            # kinds
            (r"[A-Z][\w!:?]*", Name.Class),
...
class TeaLangLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"/\*.*?\*/", Comment.Multiline),
            (r"@[a-zA-Z_][\w\.]*", Name.Decorator),
            (r"(and|break|else|foreach|if|in|not|or|reverse)\b", Keyword),
        ...
        "template": [(r"[a-zA-Z_]\w*", Name.Class, "#pop")],
        "import": [(r"[\w.]+\*?", Name.Namespace, "#pop")],
    }
    ...
    tokens = {
        "root": [
            ...
            (
                ...
                r"annotation|sealed)\b",
                Name.Decorator,
            ),
            (
                r"(break|case|catch|continue|else|finally|for|in|"
                r"if|return|switch|this|throw|try|while|is|exists|dynamic|"
                r"nonempty|then|outer|assert|let)\b",
                Keyword,
            ),
            (r"(abstracts|extends|satisfies|" r"super|given|of|out|assign)\b", Keyword.Declaration),
            (r"(function|value|void|new)\b", Keyword.Type),
            (r"(assembly|module|package)(\s+)", bygroups(Keyword.Namespace, Whitespace)),
            (r"(true|false|null)\b", Keyword.Constant),
            (r"(class|interface|object|alias)(\s+)", bygroups(Keyword.Declaration, Whitespace), "class"),
            (r"(import)(\s+)", bygroups(Keyword.Namespace, Whitespace), "import"),
            (r'"(\\\\|\\[^\\]|[^"\\])*"', String),
        ...
        "class": [(r"[A-Za-z_]\w*", Name.Class, "#pop")],
        "import": [(r"[a-z][\w.]*", Name.Namespace, "#pop")],
        "comment": [
            (r"[^*/]", Comment.Multiline),
            (r"/\*", Comment.Multiline, "#push"),
            (r"\*/", Comment.Multiline, "#pop"),
...
class KotlinLexer(RegexLexer):
    ...
    modifiers = (
        r"actual|abstract|annotation|companion|const|crossinline|"
    ...
    tokens = {
        "root": [
            ...
            (
                words(
                    ("Boolean", "Byte", "Char", "Double", "Float", "Int", "Long", "Short", "String", "Any", "Unit"),
                    suffix=r"\b",
                ),
                Keyword.Type,
            ),
            ...
            (
                ...
                bygroups(using(this, state="modifiers"), Keyword.Declaration, Whitespace),
                "class",
            ),
            # Variables
            (r"(var|val)(\s+)(\()", bygroups(Keyword.Declaration, Whitespace, Punctuation), "destructuring_assignment"),
            (
            ...
            (r"'\\.'|'[^\\]'", String.Char),
            # Numbers
            (r"[0-9](\.[0-9]*)?([eE][+-][0-9]+)?[flFL]?|" r"0[xX][0-9a-fA-F]+[Ll]?", Number),
            # Identifiers
        ...
        "modifiers": [(r"\w+", Keyword.Declaration), (r"\s+", Whitespace), default("#pop")],
        "string": [(r'"', String, "#pop"), include("string_common")],
        "multiline_string": [(r'"""', String, "#pop"), (r'"', String), include("string_common")],
        "string_common": [
            (r"\\\\", String),  # escaped backslash
            (r'\\"', String),  # escaped quote
            (r"\\", String),  # bare backslash
        ...
        "scope": [(r"\{", Punctuation, "scope"), (r"\}", Punctuation, "#pop"), include("root")],
    }
    ...
    tokens = {
        "root": [
            ...
            (
                ...
                r"protected|public|static|strictfp|super|synchronized|throws|"
                r"transient|volatile|val|var)\b",
                Keyword.Declaration,
            ),
            (r"(boolean|byte|char|double|float|int|long|short|void)\b", Keyword.Type),
            (r"(package)(\s+)", bygroups(Keyword.Namespace, Whitespace)),
        ...
        "class": [(r"[a-zA-Z_]\w*", Name.Class, "#pop")],
        "import": [(r"[\w.]+\*?", Name.Namespace, "#pop")],
        "template": [(r"'''", String, "#pop"), (r"\u00AB", String, "#pop"), (r".", String)],
    }
    ...
    tokens = {
        ...
        "keywords": [
            (
                ...
                r"stream|through|union|using|void)\b",
                Keyword,
            )
        ],
        "builtins": [
        ...
        "types": [
            (r"(bytearray|BIGINTEGER|BIGDECIMAL|chararray|datetime|double|float|" r"int|long|tuple)\b", Keyword.Type)
        ],
        "punct": [
            (r"[;(){}\[\]]", Punctuation),
        ],
...
class GoloLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"[]{}|(),[]", Punctuation),
            (r"(module|import)(\s+)", bygroups(Keyword.Namespace, Whitespace), "modname"),
            (r"\b([a-zA-Z_][\w$.]*)(::)", bygroups(Name.Namespace, Punctuation)),
            (r"\b([a-zA-Z_][\w$]*(?:\.[a-zA-Z_][\w$]*)+)\b", Name.Namespace),
            (r"(let|var)(\s+)", bygroups(Keyword.Declaration, Whitespace), "varname"),
            (r"(struct)(\s+)", bygroups(Keyword.Declaration, Whitespace), "structname"),
            (r"(function)(\s+)", bygroups(Keyword.Declaration, Whitespace), "funcname"),
            ...
            (r"(map|array|list|set|vector|tuple)(\[)", bygroups(Name.Builtin, Punctuation)),
            (r"(print|println|readln|raise|fun" r"|asInterfaceInstance)\b", Name.Builtin),
        ...
        "modname": [(r"[a-zA-Z_][\w$.]*\*?", Name.Namespace, "#pop")],
        "structname": [(r"`?[\w.]+\*?", Name.Class, "#pop")],
        "varname": [
...
class JasminLexer(RegexLexer):
    ...
    tokens = {
        "default": [
            ...
            (r"-?(\d+\.\d*|\.\d+)([eE][-+]?\d+)?[fFdD]?" rf"[\x00-\x08\x0b\x0c\x0e-\x1f]*{_break}", Number.Float),
            ...
            (rf"\.field{_break}", Keyword.Reserved, ("descriptor/convert-dots", "field")),
            (rf"(\.end|\.limit|use){_break}", Keyword.Reserved, "no-verification"),
            ...
            (rf"is{_break}", Keyword.Reserved, ("descriptor/convert-dots", "var")),
            ...
            (rf"(anewarray|checkcast|instanceof|ldc|ldc_w|new){_break}", Keyword.Reserved, "class/no-dots"),
            (
                r"invoke(dynamic|interface|nonvirtual|special|" rf"static|virtual){_break}",
                Keyword.Reserved,
                "invocation",
            ),
            (rf"(getfield|putfield){_break}", Keyword.Reserved, ("descriptor/no-dots", "field")),
            (rf"(getstatic|putstatic){_break}", Keyword.Reserved, ("descriptor/no-dots", "static")),
            (
                words(
                    (
                        "goto",
            ...
            (rf"(multianewarray|newarray){_break}", Keyword.Reserved, "descriptor/convert-dots"),
            (rf"tableswitch{_break}", Keyword.Reserved, "table"),
        ],
        "quote": [(r"'", String.Single, "#pop"), (r"\\u[\da-fA-F]{4}", String.Escape), (r"[^'\\]+", String.Single)],
        "string": [
            (r'"', String.Double, "#pop"),
            (r'\\([nrtfb"\'\\]|u[\da-fA-F]{4}|[0-3]?[0-7]{1,2})', String.Escape),
            (r'[^"\\]+', String.Double),
        ],
        "root": [
            (r"\n+", Whitespace),
            ...
            include("default"),
            (rf"({_name})([ \t\r]*)(:)", bygroups(Name.Label, Whitespace, Punctuation)),
            (_name, String.Other),
        ],
        "annotation": [
            (r"\n", Whitespace, ("#pop", "annotation-body")),
            (rf"default{_break}", Keyword.Reserved, ("#pop", "annotation-default")),
            include("default"),
        ],
        "annotation-body": [
            (r"\n+", Whitespace),
        ...
        "annotation-items": [(r"'", String.Single, "quote"), include("default"), (_name, String.Other)],
        "caught-exception": [(rf"all{_break}", Keyword, "#pop"), include("exception")],
        "class/convert-dots": [
            include("default"),
            (
            ...
            (rf"((?:{_unqualified_name}[/.])*)({_name})", bygroups(Name.Namespace, Name.Class), "#pop"),
        ],
        "class/no-dots": [
            include("default"),
        ...
        "descriptors/convert-dots": [(r"\)", Punctuation, "#pop"), default("descriptor/convert-dots")],
        "enclosing-method": [
            (_ws, Whitespace),
        ...
        "exception": [
            include("default"),
            (rf"((?:{_unqualified_name}[/.])*)({_name})", bygroups(Name.Namespace, Name.Exception), "#pop"),
        ],
        "field": [
        ...
        "label": [include("default"), (_name, Name.Label, "#pop")],
        "method": [
            include("default"),
            (
                rf"({_name})(\()",
        ...
        "no-verification": [(rf"(locals|method|stack){_break}", Keyword.Reserved, "#pop"), include("default")],
        "static": [
            include("default"),
            (
                rf"((?:{_unqualified_name}[/.](?=[^{_separator}]*[/.]))*)({_unqualified_name}[/.])?({_name})",
        ...
        "var": [include("default"), (_name, Name.Variable, "#pop")],
        "verification": [
            include("default"),
    ...
    def analyse_text(text):
        ...
        if re.search(r"^\s*\.class\s", text, re.MULTILINE):
            ...
            if re.search(r"^\s*[a-z]+_[a-z]+\b", text, re.MULTILINE):
                score += 0.3
        if re.search(
            r"^\s*\.(attribute|bytecode|debug|deprecated|enclosing|" r"inner|interface|limit|set|signature|stack)\b",
            text,
            re.MULTILINE,
        ):
            score += 0.6
...
class SarlLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(agent|annotation|artifact|behavior|capacity|class|enum|event|" r"interface|skill|space)(\s+)",
