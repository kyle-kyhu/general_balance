...
class CFamilyLexer(RegexLexer):
    ...
    tokens = {
        "whitespace": [
            ...
            # or with whitespace
            ("^(" + _ws1 + r")(#if\s+0)", bygroups(using(this), Comment.Preproc), "if0"),
        ...
        "statements": [
            ...
            (
                r"(-)?((" + _decpart + r"\.(" + _decpart + r")?|\." + _decpart + r")[fFlL]?)|(" + _decpart + r"[fFlL])",
                Number.Float,
            ),
        ...
        "types": [
            (words(("int8", "int16", "int32", "int64", "wchar_t"), prefix=r"__", suffix=r"\b"), Keyword.Reserved),
            (
                words(
                    (
                        "bool",
        ...
        "keywords": [
            ...
            (words(("inline", "_inline", "__inline", "naked", "restrict", "thread"), suffix=r"\b"), Keyword.Reserved),
            # Vector intrinsics
...
class CLexer(CFamilyLexer):
    ...
    tokens = {
        ...
        "types": [(words(("_Bool", "_Complex", "_Atomic"), suffix=r"\b"), Keyword.Type), inherit],
    }
...
class CppLexer(CFamilyLexer):
    ...
    tokens = {
        "statements": [
            ...
            (
                r'((?:[LuU]|u8)?R)(")([^\\()\s]{,16})(\()((?:.|\n)*?)(\)\3)(")',
                bygroups(String.Affix, String, String.Delimiter, String.Delimiter, String, String.Delimiter, String),
            ),
            inherit,
        ],
        "root": [
