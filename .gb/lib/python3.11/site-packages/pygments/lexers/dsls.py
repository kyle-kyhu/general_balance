...
class ProtoBufLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(message|extend)(\s+)", bygroups(Keyword.Declaration, Whitespace), "message"),
            (r"(enum|group|service)(\s+)", bygroups(Keyword.Declaration, Whitespace), "type"),
            (r"\".*?\"", String),
            (r"\'.*?\'", String),
            ...
            (r"[+-=]", Operator),
            (r"([a-zA-Z_][\w.]*)([ \t]*)(=)", bygroups(Name.Attribute, Whitespace, Operator)),
            (r"[a-zA-Z_][\w.]*", Name),
        ],
        "package": [
...
class ThriftLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(enum|union|struct|service|exception)(\s+)", bygroups(Keyword.Declaration, Whitespace), "class"),
            (
...
class ZeekLexer(RegexLexer):
    ...
    tokens = {
        ...
        "directives": [
            ...
            (r"(@prefixes)(\s*)((\+?=).*)$", bygroups(Comment.Preproc, Whitespace, Comment.Preproc)),
        ],
        "attributes": [
            (
                words(
        ...
        "identifiers": [(r"([a-zA-Z_]\w*)(::)", bygroups(Name, Punctuation)), (r"[a-zA-Z_]\w*", Name)],
        "string": [
            (r"\\.", String.Escape),
...
class PuppetLexer(RegexLexer):
    ...
    tokens = {
        ...
        "names": [
            ...
            (r"(\$\S+)(\[)(\S+)(\])", bygroups(Name.Variable, Punctuation, String, Punctuation)),
            (r"\$\S+", Name.Variable),
        ],
        "numbers": [
...
class RslLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"\{!.*?!\}", Comment),
            (r"/\*.*?\*/", Comment),
            (r"^([ \t]*)([\w]+)([ \t]*)(:[^:])", bygroups(Whitespace, Name.Function, Whitespace, Name.Function)),
            (
                r"(^[ \t]*)([\w]+)([ \t]*)(\([\w\s,]*\))([ \t]*)(is|as)",
                bygroups(Whitespace, Name.Function, Whitespace, Text, Whitespace, Keyword),
            ),
...
class MscgenLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # Options
            (r"(hscale|HSCALE|width|WIDTH|wordwraparcs|WORDWRAPARCS" r"|arcgradient|ARCGRADIENT)\b", Name.Property),
            # Operators
        ...
        "attrs": [
            (r"\]", Punctuation, "#pop"),
            (_var + r"(\s*)(=)(\s*)" + _var, bygroups(Name.Attribute, Whitespace, Operator, Whitespace, String)),
            (r",", Punctuation),
            include("comments"),
        ],
        "comments": [
...
class CrmshLexer(RegexLexer):
    ...
    sub = words(("params", "meta", "operations", "op", "rule", "attributes", "utilization"), suffix=r"(?![\w#$-])")
    ...
    tokens = {
        "root": [
            ...
            # attr=value (nvpair)
            (r'([\w#$-]+)(=)("(?:""|[^"])*"|\S+)', bygroups(Name.Attribute, Punctuation, String)),
            # need this construct, otherwise numeric node ids
            # are matched as scores
            # elem id:
            (r"(node)(\s+)([\w#$-]+)(:)", bygroups(Keyword, Whitespace, Name, Punctuation)),
            # scores
            (r"([+-]?([0-9]+|inf)):", Number),
            ...
            # acl_mod:blah
            (rf'({acl_mod})(:)("(?:""|[^"])*"|\S+)', bygroups(Keyword, Punctuation, Name)),
            # rsc_id[:(role|action)]
...
class SnowballLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "root1": [
            ...
            (r"//.*", Comment.Single),
            (r"[!*+\-/<=>]=|[-=]>|<[+-]|[$*+\-/<=>?\[\]]", Operator),
            (words(("as", "get", "hex", "among", "define", "decimal", "backwardmode"), suffix=r"\b"), Keyword.Reserved),
            (
                words(("strings", "booleans", "integers", "routines", "externals", "groupings"), suffix=r"\b"),
                Keyword.Reserved,
                "declaration",
            ),
            (
            ...
            (words(("size", "limit", "cursor", "maxint", "minint"), suffix=r"\b"), Name.Builtin),
            (rf"(stringdef\b)([{_ws}]*)([^{_ws}]+)", bygroups(Keyword.Reserved, Whitespace, String.Escape)),
            (rf"(stringescapes\b)([{_ws}]*)(.)([{_ws}]*)(.)", _stringescapes),
            (r"[A-Za-z]\w*", Name),
        ],
        "declaration": [
            (r"\)", Punctuation, "#pop"),
