...
class AntlrLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (
                r"(@" + _id + r")(\s*)(::)?(\s*)(" + _id + r")(\s*)(\{)",
                bygroups(Name.Label, Whitespace, Punctuation, Whitespace, Name.Label, Whitespace, Punctuation),
                "action",
            ),
            # rule
            (
        ...
        "rule-prelims": [
            ...
            (r"(,)(\s*)(" + _id + ")", bygroups(Punctuation, Whitespace, Name.Label)),  # Additional throws
            # optionsSpec
            (r"options\b", Keyword, "options"),
            ...
            (r"(scope)(\s+)(" + _id + r")(\s*)(;)", bygroups(Keyword, Whitespace, Name.Label, Whitespace, Punctuation)),
            # ruleAction
            (r"(@" + _id + r")(\s*)(\{)", bygroups(Name.Label, Whitespace, Punctuation), "action"),
        ...
        "tokens": [
            ...
            (r"\{", Punctuation),
            (
                r"(" + _TOKEN_REF + r")(\s*)(=)?(\s*)(" + _STRING_LITERAL + r")?(\s*)(;)",
        ...
        "options": [
            ...
            (r"\{", Punctuation),
            (
                r"(" + _id + r")(\s*)(=)(\s*)(" + "|".join((_id, _STRING_LITERAL, _INT, r"\*")) + r")(\s*)(;)",
        ...
        "action": [
            ...
            (r"(\$[a-zA-Z]+)(\.?)(text|value)?", bygroups(Name.Variable, Punctuation, Name.Property)),
            (r"\{", Punctuation, "#push"),
            (r"\}", Punctuation, "#pop"),
        ],
        "nested-arg-action": [
...
class AntlrObjectiveCLexer(DelegatingLexer):
    ...
    def analyse_text(text):
        return AntlrLexer.analyse_text(text) and re.search(r"^\s*language\s*=\s*ObjC\s*;", text)
...
class AntlrCSharpLexer(DelegatingLexer):
    ...
    def analyse_text(text):
        return AntlrLexer.analyse_text(text) and re.search(r"^\s*language\s*=\s*CSharp2\s*;", text, re.M)
...
class AntlrPythonLexer(DelegatingLexer):
    ...
    def analyse_text(text):
        return AntlrLexer.analyse_text(text) and re.search(r"^\s*language\s*=\s*Python\s*;", text, re.M)
...
class AntlrRubyLexer(DelegatingLexer):
    ...
    def analyse_text(text):
        return AntlrLexer.analyse_text(text) and re.search(r"^\s*language\s*=\s*Ruby\s*;", text, re.M)
...
class AntlrPerlLexer(DelegatingLexer):
    ...
    def analyse_text(text):
        return AntlrLexer.analyse_text(text) and re.search(r"^\s*language\s*=\s*Perl5\s*;", text, re.M)
...
class AntlrActionScriptLexer(DelegatingLexer):
    ...
    def analyse_text(text):
        return AntlrLexer.analyse_text(text) and re.search(r"^\s*language\s*=\s*ActionScript\s*;", text, re.M)
