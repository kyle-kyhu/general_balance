...
class AdaLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(subtype|type)(\s+)(\w+)", bygroups(Keyword.Declaration, Text, Keyword.Type), "type_def"),
            ...
            (r"(\w+)(\s*)(:)(\s*)(constant)", bygroups(Name.Constant, Text, Punctuation, Text, Keyword.Reserved)),
            (r"<<\w+>>", Name.Label),
            (
