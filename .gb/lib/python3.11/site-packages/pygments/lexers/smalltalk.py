...
class SmalltalkLexer(RegexLexer):
    ...
    tokens = {
        ...
        "squeak fileout": [
            ...
            (r"^(\w+(?: class)?)(\s+instanceVariableNames: )(.*?)(!)", bygroups(Name.Class, Keyword, String, Keyword)),
...
class NewspeakLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"'[^']*'", String),
            (r"\b(class)(\s+)(\w+)(\s*)", bygroups(Keyword.Declaration, Text, Name.Class, Text)),
            (r"\b(mixin|self|super|private|public|protected|nil|true|false)\b", Keyword),
            (r"(\w+\:)(\s*)([a-zA-Z_]\w+)", bygroups(Name.Function, Text, Name.Variable)),
