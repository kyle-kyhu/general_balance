...
class HaxeLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "abstract": [
            include("spaces"),
            default(
                ("#pop", "abstract-body", "abstract-relation", "abstract-opaque", "type-param-constraint", "type-name")
            ),
        ],
        "abstract-body": [
            include("spaces"),
        ...
        "class": [
            include("spaces"),
            default(("#pop", "class-body", "bracket-open", "extends", "type-param-constraint", "type-name")),
        ],
        "extends": [
            include("spaces"),
...
class HxmlLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(--)(neko-source|flash-strict|flash-use-stage|no-opt|no-traces|" r"no-inline|times|no-output)",
                bygroups(Punctuation, Keyword),
            ),
            # Targets and other options that take an argument
            (
                r"(-)(cpp|js|neko|x|as3|swf9?|swf-lib|php|xml|main|lib|D|resource|" r"cp|cmd)( +)(.+)",
            ...
            (
                r"(--)(js-namespace|php-front|php-lib|remap|gen-hx-classes)( +)" r"(.+)",
                bygroups(Punctuation, Keyword, Whitespace, String),
            ),
