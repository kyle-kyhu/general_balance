...
class ResourceLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"-?\d+", Number.Integer),
            (r"[,{}]", Operator),
            (r"([^\s{{:]+)(\s*)({}?)".format("|".join(_types)), bygroups(Name, Text, Keyword)),
            (r"\s+", Text),
        ...
        "msgname": [(r"([^{},]+)(\s*)", bygroups(Name, String.Escape), ("#pop", "message"))],
        "message": [
            (r"\{", String.Escape, "msgname"),
            (r"\}", String.Escape, "#pop"),
            (r"(,)(\s*)([a-z]+)(\s*\})", bygroups(Operator, String.Escape, Keyword, String.Escape), "#pop"),
            (
            ...
            (
                r"(,)(\s*)([a-z]+)(\s*)(,)(\s*)",
                bygroups(Operator, String.Escape, Keyword, String.Escape, Operator, String.Escape),
                "choice",
            ),
            (r"\s+", String.Escape),
        ],
        ...
        "str": [(r"\}", String.Escape, "#pop"), (r"\{", String.Escape, "msgname"), (r"[^{}]+", String)],
    }
