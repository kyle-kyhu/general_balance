...
class ModelicaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (
                r"(block|class|connector|end|function|model|operator|package|" r"record|type)\b",
                Keyword.Reserved,
                "class",
            ),
        ...
        "package-prefix": [include("whitespace"), (_name, Name.Namespace, "#pop"), default("#pop")],
        "string": [
            (r'"', String.Double, "#pop"),
            (r'\\[\'"?\\abfnrtv]', String.Escape),
            (r'(?i)<\s*html\s*>([^\\"]|\\.)+?(<\s*/\s*html\s*>|(?="))', using(HtmlLexer)),
            (r'<|\\?[^"\\<]+', String.Double),
        ],
    }
...
class BugsLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            # Built-in Functions
            (r"({})(?=\s*\()".format(r"|".join(_FUNCTIONS + _DISTRIBUTIONS)), Name.Builtin),
...
class JagsLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"({})(?=\s*\()".format(r"|".join(_FUNCTIONS + _DISTRIBUTIONS + _OTHER_DISTRIBUTIONS)), Name.Builtin),
            # Names
            include("names"),
            # Number Literals
            (r"[-+]?[0-9]*\.?[0-9]+([eE][-+]?[0-9]+)?", Number),
