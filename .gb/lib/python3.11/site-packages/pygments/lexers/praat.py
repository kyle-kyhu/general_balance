...
class PraatLexer(RegexLexer):
    ...
    tokens = {
        ...
        "comma_list": [
            ...
            (r"(\s*)(?:([)\]])|(\n))", bygroups(Whitespace, Punctuation, Whitespace), "#pop"),
            (r"\s+", Whitespace),
            (r'"', String, "string"),
        ...
        "variable_name": [
            ...
            (words(variables_numeric, suffix=r'(?=[^a-zA-Z0-9_."\'$#\[:(]|\s|^|$)'), Name.Variable.Global),
            (words(objects, prefix=r"\b", suffix=r"(_)"), bygroups(Name.Builtin, Name.Builtin), "object_reference"),
            (r"\.?_?[a-z][\w.]*(\$|#)?", Text),
        ...
        "string_interpolated": [
            (r'\'[_a-z][^\[\]\'":]*(\[([\d,]+|"[\w,]+")\])?(:[0-9]+)?\'', String.Interpol),
        ],
        "string_unquoted": [
            (r"(\n\s*)(\.{3})", bygroups(Whitespace, Punctuation)),
            (r"\n", Whitespace, "#pop"),
        ...
        "old_form": [
            ...
            (r"(option|button)([ \t]+)", bygroups(Keyword, Whitespace), "string_unquoted"),
            (r"(sentence|text)([ \t]+)(\S+)", bygroups(Keyword, Whitespace, String), "string_unquoted"),
            (
                r"(word)([ \t]+)(\S+)([ \t]*)(\S+)?(?:([ \t]+)(.*))?",
                bygroups(Keyword, Whitespace, Text, Whitespace, Text, Whitespace, Text),
            ),
            (r'(boolean)(\s+\S+\s*)(0|1|"?(?:yes|no)"?)', bygroups(Keyword, Whitespace, Name.Variable)),
            # Ideally processing of the number would happen in the 'number'
            # but that doesn't seem to work
            (
                r"(real|natural|positive|integer)([ \t]+\S+[ \t]*)([+-]?)(\d+(?:\.\d*)?" r"(?:[eE][-+]?\d+)?%?)",
