...
class FactorLexer(RegexLexer):
    ...
    builtin_strings = words(("1string", "<string>", ">string", "resize-string", "string", "string?"), suffix=r"(\s+)")

    builtin_vectors = words(("1vector", "<vector>", ">vector", "?push", "vector", "vector?"), suffix=r"(\s+)")
    ...
    tokens = {
        ...
        "base": [
            (r"\s+", Whitespace),
            # defining words
            (r"((?:MACRO|MEMO|TYPED)?:[:]?)(\s+)(\S+)", bygroups(Keyword, Whitespace, Name.Function)),
            (r"(M:[:]?)(\s+)(\S+)(\s+)(\S+)", bygroups(Keyword, Whitespace, Name.Class, Whitespace, Name.Function)),
            (r"(C:)(\s+)(\S+)(\s+)(\S+)", bygroups(Keyword, Whitespace, Name.Function, Whitespace, Name.Class)),
            ...
            (r"(USE:|UNUSE:|IN:|QUALIFIED:)(\s+)(\S+)", bygroups(Keyword.Namespace, Whitespace, Name.Namespace)),
            (
                r"(QUALIFIED-WITH:)(\s+)(\S+)(\s+)(\S+)",
                bygroups(Keyword.Namespace, Whitespace, Name.Namespace, Whitespace, Name.Namespace),
            ),
            (
            ...
            (
                ...
                bygroups(Keyword.Namespace, Whitespace, Name.Function, Whitespace, Name.Function),
            ),
            (r"(DEFER:|FORGET:|POSTPONE:)(\s+)(\S+)", bygroups(Keyword.Namespace, Whitespace, Name.Function)),
            # tuples and classes
            (
            ...
            (r"(TUPLE:|ERROR:|BUILTIN:)(\s+)(\S+)", bygroups(Keyword, Whitespace, Name.Class), "slots"),
            (r"(MIXIN:|UNION:|INTERSECTION:)(\s+)(\S+)", bygroups(Keyword, Whitespace, Name.Class)),
            (
                r"(PREDICATE:)(\s+)(\S+)(\s+)(<)(\s+)(\S+)",
                bygroups(Keyword, Whitespace, Name.Class, Whitespace, Punctuation, Whitespace, Name.Class),
            ),
            (r"(C:)(\s+)(\S+)(\s+)(\S+)", bygroups(Keyword, Whitespace, Name.Function, Whitespace, Name.Class)),
            (r"(INSTANCE:)(\s+)(\S+)(\s+)(\S+)", bygroups(Keyword, Whitespace, Name.Class, Whitespace, Name.Class)),
            ...
            # other syntax
            (r"(CONSTANT:|SYMBOL:|MAIN:|HELP:)(\s+)(\S+)", bygroups(Keyword, Whitespace, Name.Function)),
            ...
            (
                r"(FUNCTION-ALIAS:)(\s+)" r"(\S+)(\s+)(\S+)(\s+)" r"(\S+)(\s+)" r"(\()(\s+)([^)]+)(\))(\s)",
                bygroups(
                    Keyword.Namespace,
                    Whitespace,
                    Text,
            ...
            (r"(CHAR:)(\s+)(\\[\\abfnrstv]|[^\\]\S*)(\s)", bygroups(String.Char, Whitespace, String.Char, Whitespace)),
            # comments
            (r"!\s+.*$", Comment),
            (r"#!\s+.*$", Comment),
            (r"/\*\s+(?:.|\n)*?\s\*/", Comment),
        ...
        "slots": [
            ...
            (
                r"(\{)(\s+)(\S+)(\s+)([^}]+)(\s+)(\})(\s+)",
                bygroups(Text, Whitespace, Name.Variable, Whitespace, Text, Whitespace, Text, Whitespace),
            ),
            (r"\S+", Name.Variable),
        ],
        "vocabs": [
