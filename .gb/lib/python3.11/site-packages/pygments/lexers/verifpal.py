...
class VerifpalLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(principal)( +)(\w+)( *)(\[)(.*)$",
                bygroups(Name.Builtin, Whitespace, String, Whitespace, Punctuation, Whitespace),
            ),
            (
                r"(attacker)( *)(\[)( *)(passive|active)( *)(\])( *)$",
                bygroups(
                    Name.Builtin, Whitespace, Punctuation, Whitespace, String, Whitespace, Punctuation, Whitespace
                ),
            ),
            (
            ...
            (
                r"(\w+)( +)(->|→)( *)(\w+)( *)(\:)",
                bygroups(String, Whitespace, Punctuation, Whitespace, String, Whitespace, Punctuation),
                "shared",
            ),
        ...
        "shared": [(r"[\^\[\],]", Punctuation), (r" +", Whitespace), (r"\w+", Name.Variable), default("#pop")],
        "queries": [
            (r"\s+", Name.Variable),
            (
                words(
                    ("confidentiality?", "authentication?", "freshness?", "unlinkability?", "equivalence?"),
                    suffix="( )",
                ),
                bygroups(Keyword.Pseudo, Whitespace),
                "shared",
            ),
            default("#pop"),
        ],
