...
from pygments.token import Punctuation, Text, Comment, Operator, Keyword, Name, String
    ...
    tokens = {
        "root": [
            ...
            (
                ...
                r"_UNIX|_VFP|_WINDOWS|_WIZARD|_WRAP",
                Keyword.Pseudo,
            ),
            ...
            (
                ...
                r"XMLAdapter|XMLField|XMLTable",
                Name.Class,
            ),
            ...
            (
                ...
                r"WriteExpression|WriteMethod|ZOrder)",
                Name.Function,
            ),
            (
                ...
                r"UnDock|UnloadReport|Unload|UpClick|Valid|When)",
                Name.Function,
            ),
            (r"\s+", Text),
        ...
        "newline": [
            ...
            (r"#\s*(IF|ELIF|ELSE|ENDIF|DEFINE|IFDEF|IFNDEF|INCLUDE)", Comment.Preproc, "#pop"),
