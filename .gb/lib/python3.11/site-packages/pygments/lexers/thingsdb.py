...
class ThingsDBLexer(RegexLexer):
    ...
    tokens = {
        ...
        "expression": [
            ...
            (r"[-+]?((inf|nan)([^0-9A-Za-z_]|$)|[0-9]*\.[0-9]+(e[+-][0-9]+)?)", Number.Float),
            # strings
            (r'(?:"(?:[^"]*)")+', String.Double),
            (r"(?:'(?:[^']*)')+", String.Single),
            (r"(?:`(?:[^`]*)`)+", String.Backtick),
        ...
        "names": [
            ...
            (r"(\.[A-Za-z_][0-9A-Za-z_]*)" r"(\s*)(=)", bygroups(Name.Attribute, Text, Operator)),
            (r"\.[A-Za-z_][0-9A-Za-z_]*", Name.Attribute),
            (r"([A-Za-z_][0-9A-Za-z_]*)(\s*)(=)", bygroups(Name.Variable, Text, Operator)),
