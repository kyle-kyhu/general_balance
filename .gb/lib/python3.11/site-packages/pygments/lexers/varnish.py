...
class VCLLexer(RegexLexer):
    ...
    tokens = {
        "probe": [
            include("whitespace"),
            include("comments"),
            (r"(\.\w+)(\s*=\s*)([^;]*)(;)", bygroups(Name.Attribute, Operator, using(this), Punctuation)),
            (r"\}", Punctuation, "#pop"),
        ],
        "acl": [
            include("whitespace"),
        ...
        "backend": [
            include("whitespace"),
            (r"(\.probe)(\s*=\s*)(\w+)(;)", bygroups(Name.Attribute, Operator, Name.Variable.Global, Punctuation)),
            (r"(\.probe)(\s*=\s*)(\{)", bygroups(Name.Attribute, Operator, Punctuation), "probe"),
            (r"(\.\w+\b)(\s*=\s*)([^;\s]*)(\s*;)", bygroups(Name.Attribute, Operator, using(this), Punctuation)),
            (r"\{", Punctuation, "#push"),
            (r"\}", Punctuation, "#pop"),
        ],
        "statements": [
            ...
            (
                r"(pipe|retry|hash|synth|deliver|purge|abandon|lookup|pass|fail|ok|" r"miss|fetch|restart)\b",
                Name.Constant,
            ),
            ...
            (r"(sub\s+)([a-zA-Z]\w*)(\s*\{)", bygroups(Keyword, Name.Function, Punctuation)),
            (
...
class VCLSnippetLexer(VCLLexer):
    ...
    tokens = {
        "snippetspre": [
            (r"\.\.\.+", Comment),
            (r"(bereq|req|req_top|resp|beresp|obj|client|server|local|remote|" r"storage)($|\.\*)", Name.Variable),
        ],
        "snippetspost": [
