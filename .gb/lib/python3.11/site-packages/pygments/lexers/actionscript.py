...
class ActionScriptLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(true|false|null|NaN|Infinity|-Infinity|undefined|Void)\b", Keyword.Constant),
            (
                words(
                    (
                        "Accessibility",
...
class ActionScript3Lexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(var|const)(\s+)(" + identifier + r")(\s*)(:)(\s*)(" + typeidentifier + r")",
                bygroups(Keyword.Declaration, Whitespace, Name, Whitespace, Punctuation, Whitespace, Keyword.Type),
            ),
            (
        ...
        "funcparams": [
            (r"\s+", Whitespace),
            (
                r"(\s*)(\.\.\.)?(" + identifier + r")(\s*)(:)(\s*)(" + typeidentifier + r"|\*)(\s*)",
                bygroups(Whitespace, Punctuation, Name, Whitespace, Operator, Whitespace, Keyword.Type, Whitespace),
                "defval",
            ),
            (r"\)", Operator, "type"),
        ],
        ...
        "defval": [
            (r"(=)(\s*)([^(),]+)(\s*)(,?)", bygroups(Operator, Whitespace, using(this), Whitespace, Operator), "#pop"),
            (r",", Operator, "#pop"),
            default("#pop"),
        ],
    }
...
class MxmlLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ("[^<&]+", Text),
            (r"&\S*?;", Name.Entity),
            (r"(\<\!\[CDATA\[)(.*?)(\]\]\>)", bygroups(String, using(ActionScript3Lexer), String)),
            ("<!--", Comment, "comment"),
            (r"<\?.*?\?>", Comment.Preproc),
            ("<![^>]*>", Comment.Preproc),
            (r"<\s*[\w:.-]+", Name.Tag, "tag"),
