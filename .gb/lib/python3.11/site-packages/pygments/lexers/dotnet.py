...
class CSharpLexer(RegexLexer):
    ...
    levels = {
        ...
        "full": (
            ...
            + "])"
            + "[^"
            + uni.allexcept("Lu", "Ll", "Lt", "Lm", "Lo", "Nl", "Nd", "Pc", "Cf", "Mn", "Mc")
            + "]*"
        ),
    }
        ...
        tokens[levelname] = {
            "root": [
                ...
                (
                    ...
                    r"(\s*)(\()",  # signature start
                    bygroups(Whitespace, using(this), Name.Function, Whitespace, Punctuation),
                ),
                ...
                (r'\$?"(\\\\|\\[^\\]|[^"\\\n])*["\n]', String),
                (r"'\\.'|'[^\\]'", String.Char),
                (r"[0-9]+(\.[0-9]*)?([eE][+-][0-9]+)?" r"[flFLdD]?|0[xX][0-9a-fA-F]+[Ll]?", Number),
                (
                    r"(#)([ \t]*)(if|endif|else|elif|define|undef|"
                    r"line|error|warning|region|endregion|pragma)\b(.*?)(\n)",
                    bygroups(Comment.Preproc, Whitespace, Comment.Preproc, Comment.Preproc, Whitespace),
                ),
    ...
    for levelname, cs_ident in levels.items():
        tokens[levelname] = {
            "root": [
                ...
                (r"/[*].*?[*]/", Comment.Multiline),
                (r"\n", Whitespace),
                (r'(\$)(\s*)(")', bygroups(String, Whitespace, String), "splice-string"),
                (r"(\$)(\s*)(<#)", bygroups(String, Whitespace, String), "splice-string2"),
                (r"<#", String, "recursive-string"),
                (r"(<\[)(\s*)(" + cs_ident + ":)?", bygroups(Keyword, Whitespace, Keyword)),
                (r"\]\>", Keyword),
                # quasiquotation only
                (r"\$" + cs_ident, Name),
                ...
                (
                    r"(#)([ \t]*)(if|endif|else|elif|define|undef|" r"line|error|warning|region|endregion|pragma)\b",
                ...
                (r"(:>?)(\s*)(" + cs_ident + r"\??)", bygroups(Punctuation, Whitespace, Keyword.Type)),
                (r"(class|struct|variant|module)(\s+)", bygroups(Keyword, Whitespace), "class"),
                (r"(namespace|using)(\s+)", bygroups(Keyword, Whitespace), "namespace"),
                (cs_ident, Name),
            ],
            "class": [(cs_ident, Name.Class, "#pop")],
            "preproc": [(r"\w+", Comment.Preproc), (r"[ \t]+", Whitespace), (r"\n", Whitespace, "#pop")],
            "namespace": [
                (r"(?=\()", Text, "#pop"),  # using (resource)
                ("(" + cs_ident + r"|\.)+", Name.Namespace, "#pop"),
            ],
            ...
            "recursive-string": [(r"[^#<>]", String), (r"<#", String, "#push"), (r"#>", String, "#pop")],
...
class VbNetLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(?<!\.)(Function|Sub|Property)(\s+)", bygroups(Keyword, Whitespace), "funcname"),
            (r"(?<!\.)(Class|Structure|Enum)(\s+)", bygroups(Keyword, Whitespace), "classname"),
            (r"(?<!\.)(Module|Namespace|Imports)(\s+)", bygroups(Keyword, Whitespace), "namespace"),
            (
            ...
            (
                r"(?<!\.)(AddressOf|And|AndAlso|As|GetType|In|Is|IsNot|Like|Mod|" r"Or|OrElse|TypeOf|Xor)\b",
                Operator.Word,
            ),
            (r"&=|[*]=|/=|\\=|\^=|\+=|-=|<<=|>>=|<<|>>|:=|" r"<=|>=|<>|[-&*/\\^+=<>\[\]]", Operator),
            ('"', String, "string"),
        ...
        "end": [
            (r"\s+", Whitespace),
            (r"(Function|Sub|Property|Class|Structure|Enum|Module|Namespace)\b", Keyword, "#pop"),
            default("#pop"),
        ],
    }
...
class GenericAspxLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(<script.*?>)(.*?)(</script>)", bygroups(using(XmlLexer), Other, using(XmlLexer))),
            (r"(.+?)(?=<)", using(XmlLexer)),
            (r".+", using(XmlLexer)),
        ],
    }
...
class FSharpLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r'"""', String, "tqs"),
            (r'"', String, "string"),
            (r"\b(open|module)(\s+)([\w.]+)", bygroups(Keyword, Whitespace, Name.Namespace)),
...
class XppLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(tableNum\()(" + XPP_CHARS + r")(\s*\))", bygroups(using(this), Name.Variable.Class, using(this))),
