...
class SMLLexer(RegexLexer):
    ...
    tokens = {
        ...
        "core": [
            ...
            (r"({})".format("|".join(re.escape(z) for z in nonid_reserved)), Punctuation),
            ...
            (r"\b(functor|include|open|signature|structure)\b(?!\')", Keyword.Reserved, "sname"),
        ...
        "vname": [
            ...
            (r"\'[\w\']*", Name.Decorator),
            (r"\(", Punctuation, "tyvarseq"),
            (rf"({alphanumid_re})(\s*)(=(?!{symbolicid_re}))", bygroups(Name.Variable, Text, Punctuation), "#pop"),
            (rf"({symbolicid_re})(\s*)(=(?!{symbolicid_re}))", bygroups(Name.Variable, Text, Punctuation), "#pop"),
        ...
        "dname": [
            ...
            (r"\'[\w\']*", Name.Decorator),
            (r"\(", Punctuation, "tyvarseq"),
            (r"(=)(\s*)(datatype)", bygroups(Punctuation, Text, Keyword.Reserved), "#pop"),
            (rf"=(?!{symbolicid_re})", Punctuation, ("#pop", "datbind", "datcon")),
            (rf"({alphanumid_re})", Keyword.Type),
            (rf"({symbolicid_re})", Keyword.Type),
            (r"\S+", Error, "#pop"),
        ],
        ...
        "datbind": [
            ...
            (rf"(\|)(\s*)({alphanumid_re})", bygroups(Punctuation, Text, Name.Class)),
            (rf"(\|)(\s+)({symbolicid_re})", bygroups(Punctuation, Text, Name.Class)),
            include("breakout"),
            include("core"),
            (r"\S+", Error),
        ],
        ...
        "ename": [
            include("whitespace"),
            (rf"(and\b)(\s+)({alphanumid_re})", bygroups(Keyword.Reserved, Text, Name.Class)),
            (rf"(and\b)(\s*)({symbolicid_re})", bygroups(Keyword.Reserved, Text, Name.Class)),
            (r"\b(of)\b(?!\')", Keyword.Reserved),
