...
class BaseMakefileLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"'(\\\\|\\[^\\]|[^'\\])*'", String.Single),
            # targets
            (r"([^\n:]+)(:+)([ \t]*)", bygroups(Name.Function, Operator, Whitespace), "block-header"),
            # expansions
            (r"\$\(", Keyword, "expansion"),
        ],
        "expansion": [
...
class CMakeLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"\b(\w+)([ \t]*)(\()", bygroups(Name.Builtin, Whitespace, Punctuation), "args"),
            include("keywords"),
            include("ws"),
        ],
        "args": [
        ...
        "keywords": [
            (
                r"\b(WIN32|UNIX|APPLE|CYGWIN|BORLAND|MINGW|MSVC|MSVC_IDE|MSVC60|" r"MSVC70|MSVC71|MSVC80|MSVC90)\b",
                Keyword,
            ),
        ],
        "ws": [
