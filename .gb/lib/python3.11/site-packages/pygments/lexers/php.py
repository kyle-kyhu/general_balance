...
class PhpLexer(RegexLexer):
    ...
    tokens = {
        "root": [(r"<\?(php)?", Comment.Preproc, "php"), (r"[^<]+", Other), (r"<", Other)],
        "php": [
            ...
            (r"/\*\*.*?\*/", String.Doc),
            (r"/\*.*?\*/", Comment.Multiline),
            (r"(->|::)(\s*)(" + _ident_nons + ")", bygroups(Operator, Text, Name.Attribute)),
            (r"[~!%^&*+=|:.<>/@-]+", Operator),
            ...
            (r"(const)(\s+)(" + _ident_inner + ")", bygroups(Keyword, Text, Name.Constant)),
            (
        ...
        "functionname": [include("magicfuncs"), (_ident_inner, Name.Function, "#pop"), default("#pop")],
        "string": [
            (r'"', String.Double, "#pop"),
            (r'[^{$"\\]+', String.Double),
            (r'\\([nrt"$\\]|[0-7]{1,3}|x[0-9a-f]{1,2})', String.Escape),
            (r"\$" + _ident_nons + r"(\[\S+?\]|->" + _ident_nons + ")?", String.Interpol),
            (r"(\{\$\{)(.*?)(\}\})", bygroups(String.Interpol, using(this, _startinline=True), String.Interpol)),
            (r"(\{)(\$.*?)(\})", bygroups(String.Interpol, using(this, _startinline=True), String.Interpol)),
            (r"(\$\{)(\S+)(\})", bygroups(String.Interpol, Name.Variable, String.Interpol)),
            (r"[${\\]", String.Double),
        ],
        "attribute": [
            (r"\]", Punctuation, "#pop"),
