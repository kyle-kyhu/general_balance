...
from pygments.token import Text, Keyword, Name, String, Operator, Number, Punctuation, Literal, Comment
...
def objective(baselexer):
    ...
    _oc_message = re.compile(r"\[\s*[a-zA-Z_]\w*\s+" r"(?:[a-zA-Z_]\w*\s*\]|" r"(?:[a-zA-Z_]\w*)?:)")
    ...
    class GeneratedObjectiveCVariant(baselexer):
        ...
        tokens = {
            "statements": [
                ...
                (
                    words(
                        ("id", "instancetype", "Class", "IMP", "SEL", "BOOL", "IBOutlet", "IBAction", "unichar"),
                        suffix=r"\b",
                    ),
                    Keyword.Type,
                ),
                ...
                (r"(@interface|@implementation)(\s+)", bygroups(Keyword, Text), ("#pop", "oc_classname")),
                (r"(@class|@protocol)(\s+)", bygroups(Keyword, Text), ("#pop", "oc_forward_classname")),
            ...
            "oc_classname": [
                ...
                (r"([a-zA-Z$_][\w$]*)(\s*:\s*)([a-zA-Z$_][\w$]*)?", bygroups(Name.Class, Text, Name.Class), "#pop"),
                ...
                (r"([a-zA-Z$_][\w$]*)(\s*)(\([a-zA-Z$_][\w$]*\))", bygroups(Name.Class, Text, Name.Label), "#pop"),
                # simple interface / implementation
                (r"([a-zA-Z$_][\w$]*)(\s*)(\{)", bygroups(Name.Class, Text, Punctuation), ("#pop", "oc_ivars")),
                (r"([a-zA-Z$_][\w$]*)", Name.Class, "#pop"),
            ],
            "oc_forward_classname": [
                (r"([a-zA-Z$_][\w$]*)(\s*,\s*)", bygroups(Name.Class, Text), "oc_forward_classname"),
            ...
            "method": [
                ...
                (r",", Punctuation),
                (r"\.\.\.", Punctuation),
                (r"(\(.*?\))(\s*)([a-zA-Z$_][\w$]*)", bygroups(using(this), Text, Name.Variable)),
...
class LogosLexer(ObjectiveCppLexer):
    ...
    tokens = {
        "statements": [
            ...
            (r"(%hook|%group)(\s+)([a-zA-Z$_][\w$]+)", bygroups(Keyword, Text, Name.Class), "#pop"),
        ...
        "logos_init_directive": [
            ...
            (r"([a-zA-Z$_][\w$]*)(\s*)(=)(\s*)([^);]*)", bygroups(Name.Class, Text, Punctuation, Text, Text)),
        ...
        "root": [
            ...
            (r"(%hook|%group)(\s+)([a-zA-Z$_][\w$]+)", bygroups(Keyword, Text, Name.Class)),
            (r"(%config)(\s*\(\s*)(\w+)(\s*=)(.*?)(\)\s*)", bygroups(Keyword, Text, Name.Variable, Text, String, Text)),
            (r"(%ctor)(\s*)(\{)", bygroups(Keyword, Text, Punctuation), "function"),
            (r"(%new)(\s*)(\()(.*?)(\))", bygroups(Keyword, Text, Keyword, String, Keyword)),
...
class SwiftLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # Decimal Literal
            (r"[0-9][0-9_]*(\.[0-9_]+[eE][+\-]?[0-9_]+|" r"\.[0-9_]*|[eE][+\-]?[0-9_]+)", Number.Float),
        ...
        "keywords": [
            ...
            (r"(func)(\s+)([a-zA-Z_]\w*)", bygroups(Keyword.Declaration, Text, Name.Function)),
            (r"(var|let)(\s+)([a-zA-Z_]\w*)", bygroups(Keyword.Declaration, Text, Name.Variable)),
            (
                words(
                    (
                        "actor",
        ...
        "comment": [(r":param: [a-zA-Z_]\w*|:returns?:|(FIXME|MARK|TODO):", Comment.Special)],
        # Nested
        ...
        "module": [(r"\n", Text, "#pop"), (r"[a-zA-Z_]\w*", Name.Class), include("root")],
        "preproc": [(r"\n", Text, "#pop"), include("keywords"), (r"[A-Za-z]\w*", Comment.Preproc), include("root")],
        "string": [
            (r'"', String, "#pop"),
        ...
        "string-common": [
            ...
            (
                r"""\\['"\\nrt]|\\x[0-9a-fA-F]{2}|\\[0-7]{1,3}""" r"""|\\u[0-9a-fA-F]{4}|\\U[0-9a-fA-F]{8}""",
                String.Escape,
            ),
            (r'[^\\"]+', String),
            (r"\\", String),
        ],
        "string-intp": [(r"\(", String.Interpol, "#push"), (r"\)", String.Interpol, "#pop"), include("root")],
    }
