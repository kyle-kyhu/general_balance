...
class PythonLexer(RegexLexer):
    ...
    def innerstring_rules(ttype):
        return [
            ...
            (r"%(\(\w+\))?[-#0 +]*([0-9]+|[*])?(\.([0-9]+|[*]))?" "[hlL]?[E-GXc-giorsaux%]", String.Interpol),
    ...
    tokens = {
        ...
        "expr": [
            ...
            # non-raw strings
            ('([uU]?)(""")', bygroups(String.Affix, String.Double), combined("stringescape", "tdqs")),
            ("([uU]?)(''')", bygroups(String.Affix, String.Single), combined("stringescape", "tsqs")),
            ('([uU]?)(")', bygroups(String.Affix, String.Double), combined("stringescape", "dqs")),
            ("([uU]?)(')", bygroups(String.Affix, String.Single), combined("stringescape", "sqs")),
            # non-raw bytes
            ('([bB])(""")', bygroups(String.Affix, String.Double), combined("bytesescape", "tdqs")),
            ("([bB])(''')", bygroups(String.Affix, String.Single), combined("bytesescape", "tsqs")),
            ('([bB])(")', bygroups(String.Affix, String.Double), combined("bytesescape", "dqs")),
            ("([bB])(')", bygroups(String.Affix, String.Single), combined("bytesescape", "sqs")),
            (r"[^\S\n]+", Text),
            include("numbers"),
            (r"!=|==|<<|>>|:=|[-~+/*%=<>&^|.]", Operator),
            (r"[]{}:(),;[]", Punctuation),
        ...
        "expr-keywords": [
            ...
            (
                words(("async for", "await", "else", "for", "if", "lambda", "yield", "yield from"), suffix=r"\b"),
                Keyword,
            ),
        ...
        "stringescape": [(r"\\(N\{.*?\}|u[a-fA-F0-9]{4}|U[a-fA-F0-9]{8})", String.Escape), include("bytesescape")],
        ...
        "tdqf": [(r'"""', String.Double, "#pop"), include("fstrings-double"), (r"\n", String.Double)],
        "tsqf": [(r"'''", String.Single, "#pop"), include("fstrings-single"), (r"\n", String.Single)],
        "tdqs": [(r'"""', String.Double, "#pop"), include("strings-double"), (r"\n", String.Double)],
        "tsqs": [(r"'''", String.Single, "#pop"), include("strings-single"), (r"\n", String.Single)],
    }
...
class Python2Lexer(RegexLexer):
    ...
    def innerstring_rules(ttype):
        return [
            ...
            (r"%(\(\w+\))?[-#0 +]*([0-9]+|[*])?(\.([0-9]+|[*]))?" "[hlL]?[E-GXc-giorsux%]", String.Interpol),
            # backslashes, quotes and formatting signs must be parsed one at a time
            (r'[^\\\'"%\n]+', ttype),
            (r'[\'"\\]', ttype),
            # unhandled string formatting sign
    ...
    tokens = {
        ...
        "builtins": [
            ...
            (r"(?<!\.)(self|None|Ellipsis|NotImplemented|False|True|cls" r")\b", Name.Builtin.Pseudo),
            (
                words(
                    (
                        "ArithmeticError",
...
class CythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        "builtins": [
            ...
            (r"(?<!\.)(self|None|Ellipsis|NotImplemented|False|True|NULL" r")\b", Name.Builtin.Pseudo),
            (
                words(
                    (
                        "ArithmeticError",
        ...
        "strings": [
            (r"%(\([a-zA-Z0-9]+\))?[-#0 +]*([0-9]+|[*])?(\.([0-9]+|[*]))?" "[hlL]?[E-GXc-giorsux%]", String.Interpol),
            (r'[^\\\'"%\n]+', String),
...
class DgLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(?<!\.)(self|Ellipsis|NotImplemented|None|True|False)(?!['\w])", Name.Builtin.Pseudo),
            (r"(?<!\.)[A-Z]\w*(Error|Exception|Warning)'*(?!['\w])", Name.Exception),
            (
                r"(?<!\.)(Exception|GeneratorExit|KeyboardInterrupt|StopIteration|" r"SystemExit)(?!['\w])",
                Name.Exception,
            ),
            (
                r"(?<![\w.])(except|finally|for|if|import|not|otherwise|raise|" r"subclass|while|with|yield)(?!['\w])",
                Keyword.Reserved,
            ),
            (r"[A-Z_]+'*(?!['\w])", Name),
