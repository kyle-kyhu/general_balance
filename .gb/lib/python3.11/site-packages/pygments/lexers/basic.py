...
class BlitzMaxLexer(RegexLexer):
    ...
    bmax_name = r"[a-z_]\w*"
    bmax_var = (
        rf"({bmax_name})(?:(?:([ \t]*)({bmax_sktypes})|([ \t]*:[ \t]*\b(?:Shl|Shr|Sar|Mod)\b)"
    ...
    tokens = {
        "root": [
            ...
            (r"(?:\?[\w \t]*)", Comment.Preproc),
            # Identifiers
            (rf"\b(New)\b([ \t]?)([(]?)({bmax_name})", bygroups(Keyword.Reserved, Whitespace, Punctuation, Name.Class)),
            (
            ...
            (rf"\b(Type|Extends)([ \t]+)({bmax_name})", bygroups(Keyword.Reserved, Whitespace, Name.Class)),
            # Keywords
...
class BlitzBasicLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # Identifiers
            (rf"\b(New)\b([ \t]+)({bb_name})", bygroups(Keyword.Reserved, Whitespace, Name.Class)),
            (rf"\b(Gosub|Goto)\b([ \t]+)({bb_name})", bygroups(Keyword.Reserved, Whitespace, Name.Label)),
            (
            ...
            (rf"\b(Type)([ \t]+)({bb_name})", bygroups(Keyword.Reserved, Whitespace, Name.Class)),
            # Keywords
            ...
            (
                bb_var,
                bygroups(Name.Variable, Whitespace, Keyword.Type, Whitespace, Punctuation, Whitespace, Name.Class),
            ),
        ],
        "string": [
            (r'""', String.Double),
...
class MonkeyLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(?i)^Strict\b.*\n", Keyword.Reserved),
            (r"(?i)(Const|Local|Global|Field)(\s+)", bygroups(Keyword.Declaration, Whitespace), "variables"),
            (r"(?i)(New|Class|Interface|Extends|Implements)(\s+)", bygroups(Keyword.Reserved, Whitespace), "classname"),
            (r"(?i)(Function|Method)(\s+)", bygroups(Keyword.Reserved, Whitespace), "funcname"),
            (r"(?i)(?:End|Return|Public|Private|Extern|Property|" r"Final|Abstract)\b", Keyword.Reserved),
            # Flow Control stuff
            (
        ...
        "classname": [
            ...
            # array (of given size)
            (r"(\[)(\s*)(\d*)(\s*)(\])", bygroups(Punctuation, Whitespace, Number.Integer, Whitespace, Punctuation)),
            # generics
            (r"\s+(?!<)", Whitespace, "#pop"),
            (r"<", Punctuation, "#push"),
            (r">", Punctuation, "#pop"),
...
class QBasicLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            (r"\n+", Text),
            (r"\s+", Text.Whitespace),
            (r"^(\s*)(\d*)(\s*)(REM .*)$", bygroups(Text.Whitespace, Name.Label, Text.Whitespace, Comment.Single)),
            (r"^(\s*)(\d+)(\s*)", bygroups(Text.Whitespace, Name.Label, Text.Whitespace)),
            (r"(?=[\s]*)(\w+)(?=[\s]*=)", Name.Variable.Global),
            (r'(?=[^"]*)\'.*$', Comment.Single),
            (r'"[^\n"]*"', String.Double),
            (r"(END)(\s+)(FUNCTION|IF|SELECT|SUB)", bygroups(Keyword.Reserved, Text.Whitespace, Keyword.Reserved)),
            (
                r"(DECLARE)(\s+)([A-Z]+)(\s+)(\S+)",
            ...
            (r"(DIM)(\s+)([^\s(]+)", bygroups(Keyword.Declaration, Text.Whitespace, Name.Variable.Global)),
            (
                r"^(\s*)([a-zA-Z_]+)(\s*)(\=)",
                bygroups(Text.Whitespace, Name.Variable.Global, Text.Whitespace, Operator),
            ),
            (r"(GOTO|GOSUB)(\s+)(\w+\:?)", bygroups(Keyword.Reserved, Text.Whitespace, Name.Label)),
            (r"(SUB)(\s+)(\w+\:?)", bygroups(Keyword.Reserved, Text.Whitespace, Name.Label)),
        ...
        # XXX: use words() here
        "declarations": [
            (r"\b({})(?=\(|\b)".format("|".join(map(re.escape, declarations))), Keyword.Declaration),
        ],
        "functions": [
            (r"\b({})(?=\(|\b)".format("|".join(map(re.escape, functions))), Keyword.Reserved),
        ],
        "metacommands": [
            (r"\b({})(?=\(|\b)".format("|".join(map(re.escape, metacommands))), Keyword.Constant),
        ],
        "operators": [
            (r"\b({})(?=\(|\b)".format("|".join(map(re.escape, operators))), Operator.Word),
        ],
        "statements": [
            (r"\b({})\b".format("|".join(map(re.escape, statements))), Keyword.Reserved),
        ],
        "keywords": [
...
class VBScriptLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(dim)(\s+)([a-z_][a-z0-9_]*)", bygroups(Keyword.Declaration, Whitespace, Name.Variable), "dim_more"),
            (r"(function|sub)(\s+)([a-z_][a-z0-9_]*)", bygroups(Keyword.Declaration, Whitespace, Name.Function)),
...
class BBCBasicLexer(RegexLexer):
    ...
    tokens = {
        ...
        "code": [
            ...
            (r"(GOTO|GOSUB|THEN|RESTORE)(\s*)(\d+)", bygroups(Keyword, Whitespace, Name.Label)),
