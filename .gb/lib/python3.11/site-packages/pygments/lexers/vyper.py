...
class VyperLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # Functions (working)
            (r"(def)(\s+)([a-zA-Z_][a-zA-Z0-9_]*)", bygroups(Keyword, Whitespace, Name.Function)),
            # Event and Struct
            (r"(event|struct|interface|log)(\s+)([a-zA-Z_][a-zA-Z0-9_]*)", bygroups(Keyword, Whitespace, Name.Class)),
            # Imports
            (
                r"(from)(\s+)(vyper\.\w+)(\s+)(import)(\s+)(\w+)",
                bygroups(Keyword, Whitespace, Name.Namespace, Whitespace, Keyword, Whitespace, Name.Class),
            ),
            # Numeric Literals
            ...
            (
                words(
                    ("public", "private", "view", "pure", "constant", "immutable", "nonpayable"),
                    prefix=r"\b",
                    suffix=r"\b",
                ),
                Keyword.Declaration,
            ...
            (
                words(
                    ("msg.sender", "msg.value", "block.timestamp", "block.number", "msg.gas"),
                    prefix=r"\b",
                    suffix=r"\b",
                ),
                Name.Builtin.Pseudo,
            ...
            (
                ...
                bygroups(Keyword, Whitespace, Punctuation, Whitespace, Keyword.Type, Punctuation),
            ),
