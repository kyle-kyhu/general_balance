...
MODULES = {
    ...
    "BC Math": ("bcadd", "bccomp", "bcdiv", "bcmod", "bcmul", "bcpow", "bcpowmod", "bcscale", "bcsqrt", "bcsub"),
    "Bzip2": (
        "bzclose",
        "bzcompress",
        "bzdecompress",
    ...
    "Directory": ("chdir", "chroot", "closedir", "dir", "getcwd", "opendir", "readdir", "rewinddir", "scandir"),
    "Eio": (
        "eio_busy",
        "eio_cancel",
        "eio_chmod",
    ...
    "Exif": ("exif_imagetype", "exif_read_data", "exif_tagname", "exif_thumbnail", "read_exif_data"),
    ...
    "Fileinfo": ("finfo_buffer", "finfo_close", "finfo_file", "finfo_open", "finfo_set_flags", "mime_content_type"),
    "Filesystem": (
        "basename",
        "chgrp",
        "chmod",
    ...
    "Inotify": ("inotify_add_watch", "inotify_init", "inotify_queue_len", "inotify_read", "inotify_rm_watch"),
    "JSON": ("json_decode", "json_encode", "json_last_error_msg", "json_last_error"),
    "LDAP": (
        "ldap_8859_to_t61",
        "ldap_add_ext",
        "ldap_add",
    ...
    "Mhash": ("mhash_count", "mhash_get_block_size", "mhash_get_hash_name", "mhash_keygen_s2k", "mhash"),
    "Misc.": (
        "connection_aborted",
        "connection_status",
        "constant",
    ...
    "Shared Memory": ("shmop_close", "shmop_delete", "shmop_open", "shmop_read", "shmop_size", "shmop_write"),
    ...
    "Xhprof": ("xhprof_disable", "xhprof_enable", "xhprof_sample_disable", "xhprof_sample_enable"),
    "YAZ": (
        "yaz_addinfo",
        "yaz_ccl_conf",
        "yaz_ccl_parse",
    ...
    "Yaml": ("yaml_emit_file", "yaml_emit", "yaml_parse_file", "yaml_parse_url", "yaml_parse"),
    "Zip": (
        "zip_close",
        "zip_entry_close",
    ...
    "intl": ("intl_error_name", "intl_get_error_code", "intl_get_error_message", "intl_is_failure"),
    "libxml": (
        "libxml_clear_errors",
    ...
    "ssdeep": ("ssdeep_fuzzy_compare", "ssdeep_fuzzy_hash_filename", "ssdeep_fuzzy_hash"),
    ...
    "xattr": ("xattr_get", "xattr_list", "xattr_remove", "xattr_set", "xattr_supported"),
    "xdiff": (
