...
class SolidityLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"\b(contract)(\s+)([a-zA-Z_]\w*)", bygroups(Keyword, Whitespace, Name.Entity)),
            (
                datatype + r"(\s+)((?:external|public|internal|private)\s+)?" + r"([a-zA-Z_]\w*)",
                bygroups(Keyword.Type, Whitespace, Keyword, Name.Variable),
            ),
            (r"\b(enum|event|function|struct)(\s+)([a-zA-Z_]\w*)", bygroups(Keyword.Type, Whitespace, Name.Variable)),
