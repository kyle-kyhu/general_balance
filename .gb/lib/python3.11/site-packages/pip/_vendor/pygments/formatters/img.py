...
from pip._vendor.pygments.util import get_bool_opt, get_int_opt, get_list_opt, get_choice_opt
...
class FontManager:
    ...
    def _get_nix_font_path(self, name, style):
        proc = subprocess.Popen(["fc-list", f"{name}:style={style}", "file"], stdout=subprocess.PIPE, stderr=None)
...
class ImageFormatter(Formatter):
    ...
    def get_style_defs(self, arg=""):
        raise NotImplementedError(
            "The -S option is meaningless for the image " "formatter. Use -O style=<stylename> instead."
        )
