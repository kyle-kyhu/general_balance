...
from pip._vendor.pygments.util import get_bool_opt, get_int_opt, get_list_opt, make_analysator, Future, guess_decode
...
class ProfilingRegexLexer(RegexLexer, metaclass=ProfilingRegexLexerMeta):
    ...
    def get_tokens_unprocessed(self, text, stack=("root",)):
        ...
        data = sorted(
            (
                (s, repr(r).strip("u'").replace("\\\\", "\\")[:65], n, 1000 * t, 1000 * t / n)
