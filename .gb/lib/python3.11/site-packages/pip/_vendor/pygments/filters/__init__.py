...
from pip._vendor.pygments.token import String, Comment, Keyword, Name, Error, Whitespace, string_to_tokentype
...
class CodeTagFilter(Filter):
    ...
    def __init__(self, **options):
        ...
        self.tag_re = re.compile(r"\b({})\b".format("|".join([re.escape(tag) for tag in tags if tag])))
