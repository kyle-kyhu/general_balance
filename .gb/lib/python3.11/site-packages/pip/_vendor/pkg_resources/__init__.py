...
class WorkingSet:
    ...
    def subscribe(self, callback: Callable[[Distribution], object], existing: bool = True):
...
class _ReqExtras(Dict["Requirement", Tuple[str, ...]]):
    ...
    def markers_pass(self, req: Requirement, extras: tuple[str, ...] | None = None):
        ...
        """
        extra_evals = (req.marker.evaluate({"extra": extra}) for extra in self.get(req, ()) + (extras or (None,)))
...
class Environment:
    ...
    def obtain(
        self,
        requirement: Requirement,
        installer: Callable[[Requirement], None] | _InstallerType | None | _InstallerTypeT[_DistributionT] = None,
    ) -> Distribution | None:
