...
def traverse(
    ...
    def _traverse(obj: Any, root: bool = False, depth: int = 0) -> Node:
        ...
        try:
            fake_attributes = hasattr(obj, "awehoi234_wdfjwljet234_234wdfoijsdfmmnxpi492")
        except Exception:
        ...
        if rich_repr_result is not None:
            ...
            pop_visited(obj_id)
        elif is_dataclass(obj) and not _safe_isinstance(obj, type) and not fake_attributes and _is_dataclass_repr(obj):
            push_visited(obj_id)
            children = []
            append = children.append
            if reached_max_depth:
...
if __name__ == "__main__":  # pragma: no cover
    ...
    data = {
        ...
        "bar": frozenset({1, 2, 3}),
        "defaultdict": defaultdict(list, {"crumble": ["apple", "rhubarb", "butter", "sugar", "flour"]}),
        "counter": Counter(
            [
                "apple",
                "orange",
