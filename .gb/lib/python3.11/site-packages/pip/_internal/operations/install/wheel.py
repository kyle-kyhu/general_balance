...
def message_about_scripts_not_on_PATH(scripts: Sequence[str]) -> Optional[str]:
    ...
    not_warn_dirs = [
        os.path.normcase(os.path.normpath(i)).rstrip(os.sep) for i in os.environ.get("PATH", "").split(os.pathsep)
    ]
...
def _normalized_outrows(
    ...
    return sorted((record_path, hash_, str(size)) for record_path, hash_, size in outrows)
...
class PipScriptMaker(ScriptMaker):
    def make(self, specification: str, options: Optional[Dict[str, Any]] = None) -> List[str]:
...
def _install_wheel(  # noqa: C901, PLR0915 function is too long
    ...
    def record_installed(srcfile: RecordPath, destfile: str, modified: bool = False) -> None:
    ...
    def data_scheme_file_maker(zip_file: ZipFile, scheme: Scheme) -> Callable[[RecordPath], "File"]:
    ...
    script_scheme_files: Iterator[File] = map(make_data_scheme_file, script_scheme_paths)
